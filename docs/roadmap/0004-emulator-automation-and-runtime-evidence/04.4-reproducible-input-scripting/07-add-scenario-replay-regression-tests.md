# Task 04.4 - Reproducible Input Scripting / Subtask 07 - Add scenario replay regression tests

## Objective

Create `tests/integration/test_input_scenarios.py`; replay twice from same state, compare emitted
events and verify cleanup/cancellation behavior.
