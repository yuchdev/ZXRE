# Task 04.4 - Reproducible Input Scripting / Subtask 02 - Define ZX Spectrum logical key map

## Objective

Create `src/zxre/platforms/zx_spectrum_input.py` and tests for letters, digits, ENTER, SPACE, CAPS
SHIFT, SYMBOL SHIFT and logical chords. Keep emulator numeric codes out.
