# Task 04.4 - Reproducible Input Scripting / Subtask 08 - Document input scripting

## Objective

Create `docs/architecture/input-scenarios.md` covering logical keys, timing, replay guarantees and
backend mapping.
