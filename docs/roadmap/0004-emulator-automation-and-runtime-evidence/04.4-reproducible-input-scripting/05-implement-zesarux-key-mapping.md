# Task 04.4 - Reproducible Input Scripting / Subtask 05 - Implement ZEsarUX key mapping

## Objective

Create `src/zxre/adapters/zesarux/input.py` and tests mapping logical keys to ASCII typing or raw
press/release codes/chords.
