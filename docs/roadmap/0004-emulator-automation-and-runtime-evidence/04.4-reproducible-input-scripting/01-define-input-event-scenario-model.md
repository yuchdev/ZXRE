# Task 04.4 - Reproducible Input Scripting / Subtask 01 - Define input event/scenario model

## Objective

Create `src/zxre/input/model.py`, `src/zxre/input/__init__.py`, and tests. Define `InputScenario`,
`InputEvent`, `InputAction`, `LogicalKey`, `InputTiming`, `ScenarioId`; actions
press/release/tap/wait and explicit millisecond/frame timing modes.
