# Task 04.4 - Reproducible Input Scripting / Subtask 03 - Implement input scenario serialization

## Objective

Create `src/zxre/input/serialization.py` with versioned JSON/YAML (prefer existing dependencies),
platform ID, optional initial snapshot, ordered events and timing mode.
