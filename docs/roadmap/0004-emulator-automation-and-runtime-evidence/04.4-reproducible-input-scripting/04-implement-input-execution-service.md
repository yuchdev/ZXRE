# Task 04.4 - Reproducible Input Scripting / Subtask 04 - Implement input execution service

## Objective

Create `src/zxre/input/service.py`; validate platform/capability, map logical keys through backend
adapters, enforce release cleanup on errors/cancellation and return structured summary.
