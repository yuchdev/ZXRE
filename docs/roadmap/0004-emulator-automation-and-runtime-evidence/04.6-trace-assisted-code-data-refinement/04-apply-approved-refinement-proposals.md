# Task 04.6 - Trace-Assisted Code/Data Refinement / Subtask 04 - Apply approved refinement proposals

## Objective

Extend `ControlService` with explicit application, runtime-derived origin/provenance and
deterministic split/merge behavior. Default to reviewable proposals; only conflict-free auto-apply
