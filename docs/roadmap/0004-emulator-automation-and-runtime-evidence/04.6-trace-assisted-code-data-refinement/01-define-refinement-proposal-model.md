# Task 04.6 - Trace-Assisted Code/Data Refinement / Subtask 01 - Define refinement proposal model

## Objective

Create `src/zxre/control/runtime_refinement.py` and tests. Define `ControlRefinementProposal`,
`RefinementReason`, `RefinementAction`, source trace IDs and conflict diagnostics; keep proposals
separate from applied changes.
