# Task 04.5 - Screen and Machine-State Capture / Subtask 06 - Implement synchronized capture bundle service

## Objective

Create `src/zxre/capture/service.py` with `capture_bundle(...)`; pause if supported, capture
requested components, resume if configured, and record best-effort synchronization when atomic
freeze is unavailable.
