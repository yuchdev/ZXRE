# Task 04.5 - Screen and Machine-State Capture / Subtask 05 - Implement saved-snapshot capture

## Objective

Create `src/zxre/capture/snapshot.py`; save through backend to temp path, import artifact,
validate/parse with Milestone 0002 snapshot service and register provenance.
