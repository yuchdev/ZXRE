# Task 04.5 - Screen and Machine-State Capture / Subtask 04 - Implement RAM/range capture

## Objective

Create `src/zxre/capture/memory.py`; capture full RAM, arbitrary range or named platform region as
ArtifactStore-managed bytes using existing memory abstractions.
