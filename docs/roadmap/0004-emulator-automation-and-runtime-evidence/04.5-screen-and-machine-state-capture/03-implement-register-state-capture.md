# Task 04.5 - Screen and Machine-State Capture / Subtask 03 - Implement register-state capture

## Objective

Create `src/zxre/capture/registers.py`; capture normalized register map/session/platform metadata
and persist JSON artifact when part of a bundle.
