# Task 04.5 - Screen and Machine-State Capture / Subtask 07 - Add capture consistency tests

## Objective

Create `tests/integration/test_runtime_capture_bundle.py` with known fake state and optional live
ZEsarUX case; verify bytes/data and provenance.
