# Task 04.5 - Screen and Machine-State Capture / Subtask 01 - Define runtime capture model

## Objective

Create `src/zxre/capture/model.py` and tests. Define `CaptureId`, `CaptureBundle`, `ScreenCapture`,
`RegisterCapture`, `MemoryCapture`, `SnapshotCapture`; bundle references artifacts instead of
embedding large data.
