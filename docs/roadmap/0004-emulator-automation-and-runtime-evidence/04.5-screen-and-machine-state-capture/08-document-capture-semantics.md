# Task 04.5 - Screen and Machine-State Capture / Subtask 08 - Document capture semantics

## Objective

Create `docs/architecture/runtime-capture.md` covering synchronization, raw/rendered screen formats,
host-file import and source-vs-captured snapshot distinction.
