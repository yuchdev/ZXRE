# Task 04.1 - Reference Emulator Adapter / Subtask 02 - Implement ZRCP transport client

## Objective

Create `src/zxre/adapters/zesarux/zrcp.py` and tests using a fake local TCP server. Implement
connect/disconnect, serialized command execution, timeout handling, response framing and structured
transport exceptions. Keep command semantics out of transport.
