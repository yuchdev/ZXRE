# Task 04.1 - Reference Emulator Adapter / Subtask 03 - Implement ZRCP command layer

## Objective

Create `src/zxre/adapters/zesarux/commands.py` and tests. Wrap verified commands for info, reset,
memory, registers, step, breakpoints, snapshots, keys, screen, CPU history, code coverage,
transaction logging and T-states. Centralize exact command syntax and typed parsing.
