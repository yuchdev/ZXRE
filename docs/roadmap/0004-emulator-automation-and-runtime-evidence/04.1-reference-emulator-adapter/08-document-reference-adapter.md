# Task 04.1 - Reference Emulator Adapter / Subtask 08 - Document reference adapter

## Objective

Create `docs/adapters/zesarux.md` with installation/configuration, capability mapping, optional
launcher, known protocol limitations and external test command, explicitly noting replaceability.
