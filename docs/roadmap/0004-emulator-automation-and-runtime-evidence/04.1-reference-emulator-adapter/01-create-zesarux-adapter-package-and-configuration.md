# Task 04.1 - Reference Emulator Adapter / Subtask 01 - Create ZEsarUX adapter package and configuration

## Objective

Create `src/zxre/adapters/zesarux/__init__.py`, `config.py`, and tests. Define host, port, connect
timeout, reconnect preference, optional auto-launch, explicit emulator path, extra args and launch
timeout. Parse `ZESARUX_*` only here.
