# Task 04.1 - Reference Emulator Adapter / Subtask 05 - Map ZEsarUX features to runtime capabilities

## Objective

Create `src/zxre/adapters/zesarux/capabilities.py` and tests. Map verified ZRCP support/version to
generic capability sets and optional namespaced extensions.
