# Task 04.2 - Breakpoints, Watchpoints and Execution Control / Subtask 03 - Implement ZEsarUX breakpoint mapping

## Objective

Create `src/zxre/adapters/zesarux/breakpoints.py` and tests. Map execute to PC condition, memory
watches to ZRCP memory breakpoints and optional ports; own slot allocation and global enablement
internally.
