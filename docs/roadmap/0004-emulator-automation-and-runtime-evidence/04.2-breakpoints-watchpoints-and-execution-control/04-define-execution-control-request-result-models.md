# Task 04.2 - Breakpoints, Watchpoints and Execution Control / Subtask 04 - Define execution-control request/result models

## Objective

Create `src/zxre/runtime/execution.py`. Define `StepRequest`, `RunRequest`, `RunLimit`,
`ExecutionResult`, `PauseResult`; represent timeout/instruction bounds only where backend can
enforce them.
