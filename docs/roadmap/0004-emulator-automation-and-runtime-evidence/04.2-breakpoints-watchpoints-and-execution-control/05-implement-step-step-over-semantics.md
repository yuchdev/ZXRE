# Task 04.2 - Breakpoints, Watchpoints and Execution Control / Subtask 05 - Implement step/step-over semantics

## Objective

Implement through `RuntimeService` and adapters. Return normalized stop reason and before/after
PC/register summaries where available; keep step-over optional.
