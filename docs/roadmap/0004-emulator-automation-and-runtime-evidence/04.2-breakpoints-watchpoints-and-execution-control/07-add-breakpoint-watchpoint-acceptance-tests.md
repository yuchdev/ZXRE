# Task 04.2 - Breakpoints, Watchpoints and Execution Control / Subtask 07 - Add breakpoint/watchpoint acceptance tests

## Objective

Create `tests/integration/test_runtime_breakpoints.py` using fake backend for execute and write-
watch scenarios; add optional live ZEsarUX equivalents where deterministic.
