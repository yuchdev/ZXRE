# Task 04.2 - Breakpoints, Watchpoints and Execution Control / Subtask 02 - Implement breakpoint registry/lifecycle

## Objective

Create `src/zxre/runtime/breakpoint_service.py`. Map ZXRE-managed IDs to backend-native IDs,
set/enable/disable/clear/list, clean up owned breakpoints and avoid overwriting externally created
breakpoints.
