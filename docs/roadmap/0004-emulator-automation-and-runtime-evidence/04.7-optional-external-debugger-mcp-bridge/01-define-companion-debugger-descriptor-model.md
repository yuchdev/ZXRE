# Task 04.7 - Optional External Debugger/MCP Bridge / Subtask 01 - Define companion debugger descriptor model

## Objective

Create `src/zxre/integrations/debugger/model.py`, package init and tests. Describe integration
ID/name, protocol type (MCP/CLI/other), generic capability hints, configuration/docs reference,
platform compatibility and provenance mode.
