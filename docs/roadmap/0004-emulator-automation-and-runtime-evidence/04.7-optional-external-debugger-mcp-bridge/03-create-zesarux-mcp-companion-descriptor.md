# Task 04.7 - Optional External Debugger/MCP Bridge / Subtask 03 - Create zesarux-mcp companion descriptor

## Objective

Create `src/zxre/integrations/debugger/zesarux_mcp.py` and tests mapping memory, registers,
stepping, breakpoints, snapshots, screen, keyboard, coverage/history. Do not import the npm package.
