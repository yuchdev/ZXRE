# Task 04.7 - Optional External Debugger/MCP Bridge / Subtask 04 - Define exploratory-vs-canonical provenance policy

## Objective

Create `src/zxre/integrations/debugger/policy.py`; direct external calls are exploratory, while
canonicalization requires explicit import or reproduction through ZXRE runtime/capture/trace APIs.
