# Task 04.7 - Optional External Debugger/MCP Bridge / Subtask 02 - Define capability-mapping metadata

## Objective

Create `src/zxre/integrations/debugger/capabilities.py`; allow data-driven mapping such as generic
`MEMORY_READ` to external tool `peek` without making ZXRE invoke it.
