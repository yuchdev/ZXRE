# Task 04.7 - Optional External Debugger/MCP Bridge / Subtask 05 - Implement external observation import APIs

## Objective

Create `src/zxre/integrations/debugger/importer.py` for externally saved snapshots, screens,
traces/logs and optional structured observations. Store via ArtifactStore and record external
integration/source metadata without claiming ZXRE executed the action.
