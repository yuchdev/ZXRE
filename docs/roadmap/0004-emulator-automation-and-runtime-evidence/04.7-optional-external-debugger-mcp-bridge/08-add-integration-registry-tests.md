# Task 04.7 - Optional External Debugger/MCP Bridge / Subtask 08 - Add integration registry tests

## Objective

Create `src/zxre/integrations/debugger/registry.py` and tests; register `zesarux-mcp` descriptor and
verify its absence never affects runtime startup/tests.
