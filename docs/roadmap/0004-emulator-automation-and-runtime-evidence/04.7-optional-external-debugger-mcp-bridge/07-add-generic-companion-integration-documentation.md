# Task 04.7 - Optional External Debugger/MCP Bridge / Subtask 07 - Add generic companion integration documentation

## Objective

Create `docs/architecture/external-debugger-integrations.md` describing replaceable MCP/CLI
companions and no MCP-to-MCP proxy requirement.
