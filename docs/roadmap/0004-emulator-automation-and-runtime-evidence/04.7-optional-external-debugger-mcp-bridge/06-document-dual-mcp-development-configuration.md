# Task 04.7 - Optional External Debugger/MCP Bridge / Subtask 06 - Document dual-MCP development configuration

## Objective

Create `docs/integrations/zesarux-mcp.md` describing future ZXRE MCP + optional `zesarux-mcp` side-
by-side use, safe shared-emulator considerations and evidence reproduction/import.
