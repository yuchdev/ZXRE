# Task 04.3 - Execution, Memory and Coverage Tracing / Subtask 02 - Implement execution-history capture

## Objective

Create `src/zxre/trace/execution.py`. Manage enable/start/clear/stop lifecycle, bounded retrieval
and normalized ordered PC history. ZEsarUX may map to CPU history.
