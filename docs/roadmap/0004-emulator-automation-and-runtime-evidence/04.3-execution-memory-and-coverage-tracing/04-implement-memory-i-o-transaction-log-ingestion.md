# Task 04.3 - Execution, Memory and Coverage Tracing / Subtask 04 - Implement memory/I/O transaction-log ingestion

## Objective

Create `src/zxre/trace/transactions.py` plus `src/zxre/adapters/zesarux/transaction_log.py`.
Configure a project temp log, import the raw log artifact and parse supported events when feasible.
