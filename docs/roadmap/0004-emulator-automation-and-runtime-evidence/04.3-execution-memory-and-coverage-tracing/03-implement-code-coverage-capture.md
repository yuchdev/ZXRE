# Task 04.3 - Execution, Memory and Coverage Tracing / Subtask 03 - Implement code-coverage capture

## Objective

Create `src/zxre/trace/coverage.py`. Clear/enable/disable with ownership tracking and normalize
executed addresses to sorted unique coverage data.
