# Task 04.3 - Execution, Memory and Coverage Tracing / Subtask 06 - Serialize traces efficiently

## Objective

Create `src/zxre/trace/serialization.py`; prefer JSONL for event streams and compact JSON for
coverage. Support streaming read/write and explicit format version.
