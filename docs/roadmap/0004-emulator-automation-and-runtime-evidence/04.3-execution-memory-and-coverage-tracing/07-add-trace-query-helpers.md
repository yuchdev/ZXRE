# Task 04.3 - Execution, Memory and Coverage Tracing / Subtask 07 - Add trace query helpers

## Objective

Create `src/zxre/trace/query.py` for executed addresses, counts, range filtering, memory accesses,
first/last occurrence and coverage intersection/difference.
