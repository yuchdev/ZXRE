# Task 04.3 - Execution, Memory and Coverage Tracing / Subtask 05 - Implement trace capture service

## Objective

Create `src/zxre/trace/service.py` to validate capabilities, start/stop capture, normalize events,
persist raw/normalized artifacts and record session/source snapshot provenance.
