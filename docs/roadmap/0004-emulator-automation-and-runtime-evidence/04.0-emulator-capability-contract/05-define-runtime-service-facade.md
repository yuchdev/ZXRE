# Task 04.0 - Emulator Capability Contract / Subtask 05 - Define runtime service facade

## Objective

Create `src/zxre/runtime/service.py` and `tests/runtime/test_service_contract.py`. Implement
project-facing open/close session, platform compatibility validation, capability queries, normalized
timeout/error handling and delegation to the selected backend.
