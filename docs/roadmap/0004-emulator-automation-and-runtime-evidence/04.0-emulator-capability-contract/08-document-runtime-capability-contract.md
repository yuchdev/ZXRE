# Task 04.0 - Emulator Capability Contract / Subtask 08 - Document runtime capability contract

## Objective

Create `docs/architecture/runtime-capabilities.md` covering required/optional capabilities, backend
protocol, fake backend, capability errors, adapter-specific config and why ZEsarUX/`zesarux-mcp` are
