# Task 04.0 - Emulator Capability Contract / Subtask 07 - Define runtime artifact/provenance conventions

## Objective

Create `src/zxre/runtime/provenance.py`. Standardize provenance fields for backend/version,
machine/platform, session, source snapshot, operation and normalized parameters. Define which
outputs become artifacts (snapshots, screens, traces) versus transient reads.
