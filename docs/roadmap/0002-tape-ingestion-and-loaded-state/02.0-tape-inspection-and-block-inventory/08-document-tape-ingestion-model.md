# Task 02.0 - Tape Inspection and Block Inventory / Subtask 08 - Document tape ingestion model

## Objective

Create `docs/architecture/tape-ingestion.md`.

## Implementation specification

Document:
- TAP vs TZX parsing scope;
- supported TZX block IDs;
- preservation policy for unknown blocks;
- standard Spectrum header normalization;
- raw block extraction;
- checksum/diagnostic semantics;
- provenance relationship to original input;
- explicit non-goal: no BASIC semantic decoding or loader execution yet.

Add example structured inventory using fictitious filenames/data.
