# Task 02.4 - Ingestion Validation Fixtures / Subtask 03 - Create synthetic TZX fixture builder

## Objective

Create `tests/fixture_builders/tzx_builder.py`.

## Implementation specification

Support the TZX block types required by Task 02.0 tests and convenient creation of malformed/truncated
variants.

Keep the builder test-only; production code must not import it.
