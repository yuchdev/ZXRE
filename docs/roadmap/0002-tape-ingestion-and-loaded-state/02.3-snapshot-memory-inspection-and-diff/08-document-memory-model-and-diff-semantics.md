# Task 02.3 - Snapshot Memory Inspection and Diff / Subtask 08 - Document memory model and diff semantics

## Objective

Create `docs/architecture/snapshot-memory.md`.

## Implementation specification

Document:
- materialized address-space semantics;
- mapped vs absent ROM;
- range conventions;
- raw exports;
- diff run algorithm/output;
- why diff is evidence of changed bytes only, not semantic interpretation.
