# Task 11.5 - Agent Procedure Portability Review / Subtask 01 - Create procedure portability matrix

## Objective

Create `docs/agents/procedure-portability-matrix.md` listing each canonical procedure against ZX
Spectrum and C64 with status `PORTABLE`, `PARAMETERIZED`, `PLATFORM_SPECIFIC`, or `NOT_APPLICABLE`.
