# Task 11.5 - Agent Procedure Portability Review / Subtask 07 - Implement procedure selection by platform

## Objective

Create `src/zxre/procedures/selection.py` mapping canonical goals to portable or platform-specific
procedure IDs based on declared prerequisites.
