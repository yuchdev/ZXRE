# Task 11.5 - Agent Procedure Portability Review / Subtask 08 - Add cross-platform procedure lint/tests

## Objective

Render relevant procedures for both harnesses/platforms and assert no incompatible platform
tool/capability is selected.
