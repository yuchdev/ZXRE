# Task 11.5 - Agent Procedure Portability Review / Subtask 02 - Review loader/media procedures

## Objective

Classify TAP/TZX/BASIC loader analysis as ZX-specific and create C64 PRG/SYS loader procedure
variant while preserving a generic `locate-machine-code-entry` higher-level workflow.
