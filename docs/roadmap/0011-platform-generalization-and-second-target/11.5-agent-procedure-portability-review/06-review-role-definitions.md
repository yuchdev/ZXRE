# Task 11.5 - Agent Procedure Portability Review / Subtask 06 - Review role definitions

## Objective

Ensure Investigator/Critic remain portable; Loader/Asset analysts may reference platform-specialized
procedures selected from project platform ID.
