# Task 11.5 - Agent Procedure Portability Review / Subtask 09 - Document procedure taxonomy

## Objective

Create `docs/agents/platform-procedures.md` with examples and authoring rule: specialization beats
sprawling conditional generic procedures.
