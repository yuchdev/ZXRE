# Task 11.0 - Architecture Extraction Review / Subtask 09 - Add architecture leakage regression checks

## Objective

Turn stable audit rules into tests/lint so future generic modules cannot re-import ZX/ZEsarUX
adapters accidentally.
