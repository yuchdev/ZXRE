# Task 11.0 - Architecture Extraction Review / Subtask 03 - Classify coupling findings

## Objective

Create `docs/architecture/platform-coupling-audit.md` with each finding classified `GENERIC`,
`ZX_PLATFORM`, `Z80_ARCH`, `ZESARUX_ADAPTER`, `HARNESS_ADAPTER`, or `REFACTOR_REQUIRED`.
