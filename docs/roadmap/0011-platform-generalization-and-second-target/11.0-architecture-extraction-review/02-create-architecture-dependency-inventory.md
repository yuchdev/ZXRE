# Task 11.0 - Architecture Extraction Review / Subtask 02 - Create architecture dependency inventory

## Objective

Create `tools/audit_platform_coupling.py` and tests if practical. Scan imports/config/docs for
`zx_spectrum`, `z80`, `zesarux`, `zrcp`, `zesarux-mcp`, TAP/TZX and ZX-specific constants outside
allowed modules.
