# Task 11.0 - Architecture Extraction Review / Subtask 04 - Audit project/artifact/knowledge layers

## Objective

Verify project IDs, address/range refs, artifacts, evidence, hypotheses, experiments and semantic
entities do not require ZX-specific fields. Record exact violations.
