# Task 11.4 - Optional Companion MCP Proof / Subtask 02 - Create C64 companion descriptor

## Objective

Add `src/zxre/integrations/debugger/c64_companion.py` mapping available or mock tool names to
generic capabilities, lifecycle and canonicalization metadata.
