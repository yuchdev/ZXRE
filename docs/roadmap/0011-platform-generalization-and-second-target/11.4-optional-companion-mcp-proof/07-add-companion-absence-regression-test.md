# Task 11.4 - Optional Companion MCP Proof / Subtask 07 - Add companion absence regression test

## Objective

All C64 deterministic/runtime/semantic benchmark tests must initialize and run when companion
package/server is missing.
