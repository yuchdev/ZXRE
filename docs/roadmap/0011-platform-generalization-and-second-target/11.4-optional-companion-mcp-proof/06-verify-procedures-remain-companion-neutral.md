# Task 11.4 - Optional Companion MCP Proof / Subtask 06 - Verify procedures remain companion-neutral

## Objective

Run portable-procedure lint and ensure C64 workflows do not reference the companion's raw tool
names.
