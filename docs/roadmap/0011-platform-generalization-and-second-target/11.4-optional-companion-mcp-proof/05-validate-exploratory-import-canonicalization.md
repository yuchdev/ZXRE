# Task 11.4 - Optional Companion MCP Proof / Subtask 05 - Validate exploratory import/canonicalization

## Objective

Use companion to create an external observation artifact in a test scenario, then explicitly
import/reproduce it through ZXRE and verify provenance states.
