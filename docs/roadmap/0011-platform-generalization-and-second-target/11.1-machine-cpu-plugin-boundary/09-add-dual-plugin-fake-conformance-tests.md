# Task 11.1 - Machine/CPU Plugin Boundary / Subtask 09 - Add dual-plugin fake conformance tests

## Objective

Create a tiny fake second architecture/platform implementation to validate generic registries before
the real C64 plugin lands.
