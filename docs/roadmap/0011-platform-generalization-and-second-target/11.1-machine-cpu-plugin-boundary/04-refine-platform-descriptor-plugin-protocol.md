# Task 11.1 - Machine/CPU Plugin Boundary / Subtask 04 - Refine platform descriptor/plugin protocol

## Objective

Create/refine `src/zxre/platforms/plugin.py` with stable platform ID, architecture ID, address
spaces/views, regions, input descriptor, display descriptor and supported media/snapshot types.
