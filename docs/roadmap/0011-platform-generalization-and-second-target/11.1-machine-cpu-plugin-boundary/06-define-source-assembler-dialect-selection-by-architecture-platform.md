# Task 11.1 - Machine/CPU Plugin Boundary / Subtask 06 - Define source/assembler dialect selection by architecture/platform

## Objective

Refine reconstruction registry so assembler dialect/backend can be selected per
architecture/platform without hard-coded Z80 assumptions in semantic source services.
