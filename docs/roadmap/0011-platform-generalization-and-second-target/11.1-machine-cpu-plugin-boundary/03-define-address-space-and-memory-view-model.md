# Task 11.1 - Machine/CPU Plugin Boundary / Subtask 03 - Define address-space and memory-view model

## Objective

Create `src/zxre/platforms/address_space.py`. Support `AddressSpaceId`, `MemoryViewId`, mapped
regions and active CPU-visible view so C64 banking/ROM/I/O overlays can be represented without
changing generic `AddressRange` semantics.
