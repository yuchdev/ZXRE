# Task 11.1 - Machine/CPU Plugin Boundary / Subtask 02 - Move Z80 metadata into architecture plugin

## Objective

Refactor existing `platforms/z80.py` into the architecture registry boundary without changing
canonical Z80 behavior; add compatibility tests for existing project IDs/serialization.
