# Task 11.1 - Machine/CPU Plugin Boundary / Subtask 05 - Define CPU decoder backend registration by architecture

## Objective

Refactor disassembly backend registry so decoders declare supported `ArchitectureId`; Z80 decoder
remains unchanged behind this registry.
