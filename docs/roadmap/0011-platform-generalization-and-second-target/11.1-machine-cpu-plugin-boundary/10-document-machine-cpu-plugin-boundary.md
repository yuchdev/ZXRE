# Task 11.1 - Machine/CPU Plugin Boundary / Subtask 10 - Document machine/CPU plugin boundary

## Objective

Create `docs/architecture/machine-cpu-plugins.md` with ZX and second-target-driven abstractions and
explicit exclusions.
