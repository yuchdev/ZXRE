# Task 11.2 - Runtime Debugger/Emulator Plugin Boundary / Subtask 03 - Refine memory-view/runtime access APIs

## Objective

Allow read/write/capture operations to specify platform memory view when needed; default CPU-visible
view remains simple for ZX.
