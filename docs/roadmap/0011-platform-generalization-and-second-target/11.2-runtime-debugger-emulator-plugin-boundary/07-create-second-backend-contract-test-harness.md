# Task 11.2 - Runtime Debugger/Emulator Plugin Boundary / Subtask 07 - Create second-backend contract test harness

## Objective

Add reusable `tests/runtime/backend_conformance.py` that can run a capability-sensitive suite
against fake, ZEsarUX and future VICE backends.
