# Task 11.3 - Second Target Adapter / Subtask 02 - Implement C64 platform descriptor

## Objective

Create `src/zxre/platforms/c64.py` and tests with CPU-visible 64K view, RAM/ROM/I/O region metadata,
screen-related metadata where needed and stable platform ID `c64`.
