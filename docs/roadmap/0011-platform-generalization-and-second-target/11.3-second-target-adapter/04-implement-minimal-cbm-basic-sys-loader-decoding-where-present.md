# Task 11.3 - Second Target Adapter / Subtask 04 - Implement minimal CBM BASIC SYS loader decoding where present

## Objective

Create `src/zxre/basic/cbm_v2.py` or platform-specific loader module. Decode enough tokenized BASIC
V2 to identify explicit `SYS` entry candidate in synthetic PRG fixtures; do not build a full
interpreter.
