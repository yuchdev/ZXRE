# Task 11.3 - Second Target Adapter / Subtask 01 - Implement MOS 6510 architecture descriptor

## Objective

Create `src/zxre/architectures/mos6510.py` and tests covering 16-bit address space, little-endian
behavior, registers/status flags and architecture ID.
