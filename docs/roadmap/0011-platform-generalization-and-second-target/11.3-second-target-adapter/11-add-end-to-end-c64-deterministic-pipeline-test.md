# Task 11.3 - Second Target Adapter / Subtask 11 - Add end-to-end C64 deterministic pipeline test

## Objective

Import PRG, derive candidate entry, materialize memory, disassemble/classify, build references,
reconstruct source, assemble byte-exact and inspect runtime state through fake/live VICE where
available.
