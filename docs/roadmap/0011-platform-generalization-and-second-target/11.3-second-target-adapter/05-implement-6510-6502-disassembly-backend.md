# Task 11.3 - Second Target Adapter / Subtask 05 - Implement 6510/6502 disassembly backend

## Objective

Add `src/zxre/adapters/mos6502decoder/` or in-tree decoder selected during implementation. Normalize
exact instruction bytes/operands/control flow through existing disassembly contracts, including
common illegal opcodes only if backend reliably supports them.
