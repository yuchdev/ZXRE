# Task 11.3 - Second Target Adapter / Subtask 06 - Implement C64 reconstruction dialect/assembler adapter

## Objective

Select and document one reference assembler after verifying current tooling (e.g. 64tass/ACME/ca65
as appropriate). Add dialect/backend adapter and byte-exact synthetic rebuild tests.
