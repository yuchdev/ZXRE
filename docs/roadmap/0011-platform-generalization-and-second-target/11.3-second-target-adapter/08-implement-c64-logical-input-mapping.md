# Task 11.3 - Second Target Adapter / Subtask 08 - Implement C64 logical input mapping

## Objective

Create `src/zxre/platforms/c64_input.py` and VICE mapping sufficient for synthetic keyboard/joystick
scenario used by the benchmark.
