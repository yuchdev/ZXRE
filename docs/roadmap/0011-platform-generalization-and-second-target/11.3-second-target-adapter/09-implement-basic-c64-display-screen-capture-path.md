# Task 11.3 - Second Target Adapter / Subtask 09 - Implement basic C64 display/screen capture path

## Objective

Prefer backend screenshot capture first; if deterministic text/bitmap rendering is needed for
fixtures, add a narrowly scoped C64 renderer with explicit memory-view assumptions.
