# Task 11.3 - Second Target Adapter / Subtask 10 - Create legal synthetic C64 fixture

## Objective

Create generated PRG with BASIC `SYS` bootstrap or direct machine-code entry, a small main loop, one
mutable state variable and deterministic screen/state effect. Store source/generator and ground
truth.
