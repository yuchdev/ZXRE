# Task 11.3 - Second Target Adapter / Subtask 12 - Document C64 reference adapter

## Objective

Create `docs/platforms/c64.md` with supported scope, external tools, PRG-only limitation, emulator
setup and deliberate exclusions.
