# Task 11.6 - Cross-Platform Reconstruction Benchmark / Subtask 06 - Benchmark semantic hypothesis workflow

## Objective

For both targets, propose/verify one state-variable or routine-purpose hypothesis through the same
evidence/hypothesis/policy stores.
