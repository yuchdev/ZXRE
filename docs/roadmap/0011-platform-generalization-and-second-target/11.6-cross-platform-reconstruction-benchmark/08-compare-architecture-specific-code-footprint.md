# Task 11.6 - Cross-Platform Reconstruction Benchmark / Subtask 08 - Compare architecture-specific code footprint

## Objective

Generate report classifying code/modules touched by second-target support: generic refactors vs new
platform/architecture/emulator adapters. Unexpected generic changes are audit findings.
