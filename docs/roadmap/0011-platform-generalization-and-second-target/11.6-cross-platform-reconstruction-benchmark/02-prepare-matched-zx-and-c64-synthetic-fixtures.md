# Task 11.6 - Cross-Platform Reconstruction Benchmark / Subtask 02 - Prepare matched ZX and C64 synthetic fixtures

## Objective

Create fixtures with analogous structure: small loader/bootstrap, main loop, one mutable state
variable and one behavior-specific routine, while using native platform mechanisms.
