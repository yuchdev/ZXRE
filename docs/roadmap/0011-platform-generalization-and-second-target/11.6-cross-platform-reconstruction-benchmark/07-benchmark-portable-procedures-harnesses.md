# Task 11.6 - Cross-Platform Reconstruction Benchmark / Subtask 07 - Benchmark portable procedures/harnesses

## Objective

Run at least one canonical portable procedure on both targets and one platform-specific loader
procedure per target; record adapter/procedure selection.
