# Task 11.6 - Cross-Platform Reconstruction Benchmark / Subtask 10 - Add regression/CI profiles

## Objective

Always-on fake/deterministic portions run in CI; live ZEsarUX/VICE and real harness runs remain
explicit external profiles.
