# Task 11.6 - Cross-Platform Reconstruction Benchmark / Subtask 01 - Define cross-platform benchmark schema

## Objective

Create `src/zxre/benchmarks/platforms.py` and tests. Define target fixture, deterministic pipeline
assertions, semantic goal, runtime capability requirements and comparable metrics.
