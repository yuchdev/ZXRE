# Task 08.1 - Differential Memory Experiments / Subtask 02 - Implement reproducible before/after runner

## Objective

Create `src/zxre/causal/diff_runner.py`. Restore a stable snapshot, capture baseline memory, execute
one scenario, capture final memory, compute diff, and record all artifacts/provenance through
existing Experiment/Memory/Capture services.
