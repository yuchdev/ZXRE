# Task 08.1 - Differential Memory Experiments / Subtask 07 - Create differential-state-discovery Skill

## Objective

Create `skills/discover-state-by-diff/SKILL.md` combining control scenario, repeated runs, contrast
analysis, candidate ranking and hypothesis creation.
