# Task 08.1 - Differential Memory Experiments / Subtask 03 - Implement repeated-run intersection analysis

## Objective

Create `src/zxre/causal/intersection.py`. Run the same scenario N times from the same initial
snapshot and compute addresses/ranges consistently changed across runs; retain unstable/noisy
changes separately.
