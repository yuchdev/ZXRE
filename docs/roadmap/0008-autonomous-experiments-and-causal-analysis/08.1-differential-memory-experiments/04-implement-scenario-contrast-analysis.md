# Task 08.1 - Differential Memory Experiments / Subtask 04 - Implement scenario contrast analysis

## Objective

Create `src/zxre/causal/contrast.py`. Compare change sets for scenario A vs B and compute shared,
A-only, B-only and opposite-direction candidates. Examples: LEFT vs RIGHT, WAIT vs MOVE.
