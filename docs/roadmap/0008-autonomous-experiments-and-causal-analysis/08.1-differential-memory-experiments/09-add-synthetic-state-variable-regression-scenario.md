# Task 08.1 - Differential Memory Experiments / Subtask 09 - Add synthetic state-variable regression scenario

## Objective

Use fake/runtime fixture with player-like x/y plus animation/noise counters. Verify
intersection+contrast narrows candidate state but does not deterministically assign names.
