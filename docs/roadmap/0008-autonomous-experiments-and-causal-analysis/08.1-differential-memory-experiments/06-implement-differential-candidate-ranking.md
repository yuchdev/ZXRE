# Task 08.1 - Differential Memory Experiments / Subtask 06 - Implement differential candidate ranking

## Objective

Create `src/zxre/causal/diff_candidates.py`. Rank candidate ranges using deterministic signals:
repeated consistency, contrast specificity, writer/reference count, small stable width and absence
in control scenario. Return signals, not semantic conclusions.
