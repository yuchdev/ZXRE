# Task 08.1 - Differential Memory Experiments / Subtask 10 - Document differential-memory methodology

## Objective

Create `docs/analysis/differential-memory.md` covering controls, repeated intersections, noise,
contrasts and limits of correlation.
