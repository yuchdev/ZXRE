# Task 08.1 - Differential Memory Experiments / Subtask 01 - Define differential experiment model

## Objective

Create `src/zxre/causal/differential.py`, package init, and tests. Define `DifferentialScenario`,
`DifferentialRun`, `DifferentialResult`, `DiffSet`, `DiffIntersection`, and source
experiment/snapshot refs.
