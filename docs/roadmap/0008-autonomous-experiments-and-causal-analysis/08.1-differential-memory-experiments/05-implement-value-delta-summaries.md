# Task 08.1 - Differential Memory Experiments / Subtask 05 - Implement value-delta summaries

## Objective

Create `src/zxre/causal/deltas.py`. For candidate addresses, summarize signed/unsigned before→after
deltas, consistency, direction and correlation with scenario parameter. Do not label
coordinates/lives/etc.
