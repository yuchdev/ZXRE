# Task 08.0 - Experiment Designer / Subtask 04 - Implement experiment proposal compiler

## Objective

Create `src/zxre/experiment/compiler.py`. Convert a valid `ExperimentProposal` into the existing
first-class `Experiment` setup/actions/expectations model. Preserve proposal ID and
hypothesis/discriminator links.
