# Task 08.0 - Experiment Designer / Subtask 10 - Document experiment design contract

## Objective

Create `docs/analysis/experiment-design.md` covering proposal vs compiled experiment, falsification,
capability validation, cost/risk and the boundary between agent reasoning and deterministic
execution.
