# Task 08.0 - Experiment Designer / Subtask 09 - Add synthetic discrimination fixtures

## Objective

Create tests with competing hypotheses such as `A137 = player_x` vs `A137 = animation_counter`;
verify proposed structured discriminators can represent move-left/right, stand-still and
intervention outcomes without embedding semantic truth in deterministic code.
