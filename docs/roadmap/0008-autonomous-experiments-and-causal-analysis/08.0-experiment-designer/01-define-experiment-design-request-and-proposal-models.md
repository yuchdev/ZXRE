# Task 08.0 - Experiment Designer / Subtask 01 - Define experiment-design request and proposal models

## Objective

Create `src/zxre/experiment/design.py` and tests. Define `ExperimentDesignRequest`,
`ExperimentProposal`, `Discriminator`, `ExpectedOutcome`, `FalsificationCriterion`,
`ExperimentCostEstimate`, `ExperimentRiskClass`, and links to target hypotheses/frontier items.
