# Task 08.0 - Experiment Designer / Subtask 02 - Define experiment-design capability context

## Objective

Create `src/zxre/experiment/design_context.py`. Aggregate available runtime capabilities, stable
snapshots, candidate input scenarios, writable memory ranges, trace/capture availability, current
hypotheses/evidence and experiment history. Keep this structured and bounded for agent consumption.
