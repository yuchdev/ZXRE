# Task 08.0 - Experiment Designer / Subtask 06 - Create design-discriminating-experiment Skill

## Objective

Create `skills/design-discriminating-experiment/SKILL.md`. Given competing hypotheses, require
explicit discriminators, minimal intervention, restore plan, expected outcomes, falsifiers and
