# Task 08.0 - Experiment Designer / Subtask 08 - Expose experiment-design MCP tools/resources

## Objective

Add bounded tools/resources for design context, proposal creation, feasibility check, compilation
and proposal status. Do not expose a tool that executes arbitrary free-form emulator commands.
