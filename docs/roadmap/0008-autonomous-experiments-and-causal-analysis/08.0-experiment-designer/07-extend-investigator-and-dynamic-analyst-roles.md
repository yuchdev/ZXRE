# Task 08.0 - Experiment Designer / Subtask 07 - Extend Investigator and Dynamic Analyst roles

## Objective

Update `agents/investigator.md` and `agents/dynamic-analyst.md` so experiment design is a distinct
step from execution; they must choose among validated proposals rather than issuing ad-hoc
mutations.
