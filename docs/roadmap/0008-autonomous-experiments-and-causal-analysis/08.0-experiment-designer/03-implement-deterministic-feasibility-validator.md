# Task 08.0 - Experiment Designer / Subtask 03 - Implement deterministic feasibility validator

## Objective

Create `src/zxre/experiment/feasibility.py`. Validate every proposed experiment against available
runtime capabilities, platform bounds, snapshot availability, writable regions, timeout budget and
supported observation predicates. Invalid model proposals must fail before execution.
