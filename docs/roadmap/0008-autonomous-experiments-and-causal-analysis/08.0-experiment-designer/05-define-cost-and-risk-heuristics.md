# Task 08.0 - Experiment Designer / Subtask 05 - Define cost and risk heuristics

## Objective

Create `src/zxre/experiment/cost.py`. Estimate deterministic coarse cost classes from expected
runtime duration, number of restores, trace size, capture count and memory-write scope. Define
low/medium/high mutation risk without pretending to know semantic safety.
