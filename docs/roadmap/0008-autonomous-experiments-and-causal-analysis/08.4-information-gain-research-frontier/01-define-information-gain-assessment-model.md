# Task 08.4 - Information-Gain Research Frontier / Subtask 01 - Define information-gain assessment model

## Objective

Create `src/zxre/frontier/information_gain.py` and tests. Define `InformationGainAssessment`,
`OutcomePartition`, `UnlockEstimate`, `AgentEstimate`, and rationale/evidence refs.
