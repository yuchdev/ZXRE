# Task 08.4 - Information-Gain Research Frontier / Subtask 05 - Implement composite prioritization policy

## Objective

Create `src/zxre/frontier/ranking.py`. Combine deterministic signals plus optional advisory
estimates through configurable transparent weights/lexicographic policy. Missing LLM estimate must
not break frontier ranking.
