# Task 08.4 - Information-Gain Research Frontier / Subtask 03 - Implement deterministic baseline value signals

## Objective

Extend `src/zxre/frontier/priority.py` with dependency count, centrality, promotion blocker count,
unresolved competing-hypothesis count, experiment feasibility and deterministic cost class.
