# Task 08.4 - Information-Gain Research Frontier / Subtask 09 - Add ranking regression tests

## Objective

Synthetic dependency graph should prioritize an inexpensive experiment that distinguishes several
central hypotheses over costly low-impact scans; test ranking remains usable without agent
estimates.
