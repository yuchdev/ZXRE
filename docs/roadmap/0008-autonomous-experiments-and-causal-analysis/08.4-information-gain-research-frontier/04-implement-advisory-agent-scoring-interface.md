# Task 08.4 - Information-Gain Research Frontier / Subtask 04 - Implement advisory agent scoring interface

## Objective

Create `src/zxre/frontier/scoring.py`. Accept agent-supplied normalized estimates for expected
discrimination/information gain and unlock value with rationale. Keep them clearly distinct from
