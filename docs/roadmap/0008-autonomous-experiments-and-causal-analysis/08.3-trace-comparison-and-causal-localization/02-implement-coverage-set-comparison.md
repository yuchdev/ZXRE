# Task 08.3 - Trace Comparison and Causal Localization / Subtask 02 - Implement coverage set comparison

## Objective

Compute intersection, scenario-only and symmetric-difference execution addresses/ranges for two or
more traces. Collapse contiguous runs and map to known basic blocks/routine candidates.
