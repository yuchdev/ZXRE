# Task 08.3 - Trace Comparison and Causal Localization / Subtask 03 - Implement execution-count comparison

## Objective

Compare per-address/basic-block/routine execution counts with normalized deltas. Keep counts
factual; avoid semantic labels.
