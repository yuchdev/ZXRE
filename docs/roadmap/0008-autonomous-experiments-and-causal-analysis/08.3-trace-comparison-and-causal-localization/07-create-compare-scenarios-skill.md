# Task 08.3 - Trace Comparison and Causal Localization / Subtask 07 - Create compare-scenarios Skill

## Objective

Create `skills/compare-runtime-scenarios/SKILL.md` requiring matched initial snapshot, control
scenario, trace/capture artifacts, divergence analysis, candidate routine hypotheses and critic
review.
