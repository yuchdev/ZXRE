# Task 08.3 - Trace Comparison and Causal Localization / Subtask 08 - Expose trace-comparison MCP views

## Objective

Add tools/resources for coverage delta, count delta, earliest divergence, state-range access delta
and ranked routine candidates with bounded output.
