# Task 08.3 - Trace Comparison and Causal Localization / Subtask 04 - Implement ordered-trace divergence localization

## Objective

Create `src/zxre/causal/divergence.py`. Identify earliest or bounded divergence points between
comparable ordered traces, with tolerance for known nondeterministic/noise regions if explicitly
configured.
