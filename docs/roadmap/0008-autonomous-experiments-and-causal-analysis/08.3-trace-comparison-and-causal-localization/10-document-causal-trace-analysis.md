# Task 08.3 - Trace Comparison and Causal Localization / Subtask 10 - Document causal trace analysis

## Objective

Create `docs/analysis/trace-comparison.md` covering matched scenarios, divergence, count deltas,
memory-access localization and correlation/causation limits.
