# Task 08.3 - Trace Comparison and Causal Localization / Subtask 01 - Define trace comparison model

## Objective

Create `src/zxre/causal/trace_compare.py` and tests. Define `TraceComparison`, `TraceDelta`,
`ExecutionDelta`, `MemoryAccessDelta`, `RoutineDelta`, and source scenario/trace refs.
