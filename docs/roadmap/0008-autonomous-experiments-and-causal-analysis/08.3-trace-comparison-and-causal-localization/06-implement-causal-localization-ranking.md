# Task 08.3 - Trace Comparison and Causal Localization / Subtask 06 - Implement causal localization ranking

## Objective

Create `src/zxre/causal/localization.py`. Rank routines/blocks by deterministic signals: scenario-
exclusive execution, early divergence, writes to candidate state, proximity to observed event and
repeatability.
