# Task 08.5 - Autonomous Bounded Research Loop / Subtask 10 - Expose autonomy MCP tools/resources

## Objective

Add tools/resources to create/start/step/resume/stop a research run, inspect budget/state/history
and retrieve final result. Prefer explicit `step`/bounded-run semantics over an opaque infinite
call.
