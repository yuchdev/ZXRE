# Task 08.5 - Autonomous Bounded Research Loop / Subtask 11 - Add autonomous player-X acceptance scenario

## Objective

Create `tests/scenarios/m0008-player-x/` with synthetic program containing player X plus distractor
state. Bounded Investigator must autonomously narrow candidate by differential experiments,
intervene safely, attach evidence and confirm or return unresolved according to policy.
