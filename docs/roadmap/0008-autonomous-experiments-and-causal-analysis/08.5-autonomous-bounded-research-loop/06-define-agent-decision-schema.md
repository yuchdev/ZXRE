# Task 08.5 - Autonomous Bounded Research Loop / Subtask 06 - Define agent decision schema

## Objective

Create `src/zxre/autonomy/decision.py`. Agent decisions such as `SELECT_FRONTIER_ITEM`,
`PROPOSE_EXPERIMENT`, `ABANDON_LINE`, `REQUEST_CRITIC`, `DECLARE_GOAL_RESOLVED`,
`DECLARE_UNRESOLVED` must be structured, validated and logged.
