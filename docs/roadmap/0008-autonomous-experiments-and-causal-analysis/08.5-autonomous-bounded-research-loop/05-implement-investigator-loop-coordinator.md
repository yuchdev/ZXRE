# Task 08.5 - Autonomous Bounded Research Loop / Subtask 05 - Implement Investigator loop coordinator

## Objective

Create `src/zxre/autonomy/coordinator.py`. Coordinate existing services/Skills through a harness-
facing plan interface. Deterministic coordinator enforces state/budget/policy but does not itself
perform semantic model reasoning.
