# Task 08.5 - Autonomous Bounded Research Loop / Subtask 04 - Implement canonical checkpoint/resume

## Objective

Create `src/zxre/autonomy/checkpoint.py`. Persist run state referencing project
hypotheses/evidence/experiments/frontier IDs rather than copying them. Resume must reconstruct
context after process/harness restart.
