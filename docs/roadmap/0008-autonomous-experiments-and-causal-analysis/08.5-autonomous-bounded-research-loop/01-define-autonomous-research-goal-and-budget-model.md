# Task 08.5 - Autonomous Bounded Research Loop / Subtask 01 - Define autonomous research goal and budget model

## Objective

Create `src/zxre/autonomy/model.py`, package init and tests. Define `ResearchGoal`, `ResearchRunId`,
`ResearchBudget`, `ResearchRunStatus`, `StopReason`, and limits for iterations, wall-clock runtime,
experiment count, model/tool calls where measurable, trace bytes and intervention risk.
