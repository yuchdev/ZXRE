# Task 08.5 - Autonomous Bounded Research Loop / Subtask 07 - Implement loop safety/stop rules

## Objective

Create `src/zxre/autonomy/guards.py`. Stop on budget exhaustion, repeated equivalent experiments, no
feasible discriminator, unresolved high-risk intervention requirement, stale/broken project state,
promotion blocker that cannot be addressed, or explicit human stop.
