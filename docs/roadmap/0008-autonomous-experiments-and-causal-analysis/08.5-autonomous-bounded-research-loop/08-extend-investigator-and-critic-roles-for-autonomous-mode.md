# Task 08.5 - Autonomous Bounded Research Loop / Subtask 08 - Extend Investigator and Critic roles for autonomous mode

## Objective

Update role definitions with bounded-mode responsibilities, mandatory budget awareness, no silent
policy override and requirement to declare unresolved when discriminating evidence cannot be
obtained.
