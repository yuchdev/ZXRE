# Task 08.5 - Autonomous Bounded Research Loop / Subtask 02 - Define research-loop state machine

## Objective

Create `src/zxre/autonomy/state_machine.py`. States: initialize, inspect frontier, choose question,
design experiments, validate, execute, ingest evidence, critic review, policy evaluation, goal
check, continue/stop. Persist transition history.
