# Task 08.5 - Autonomous Bounded Research Loop / Subtask 03 - Implement budget accounting

## Objective

Create `src/zxre/autonomy/budget.py`. Track deterministic resource usage: experiments run, emulator
time, captures/traces, intervention count/risk, failed attempts and optional harness-reported
token/tool metrics. Hard limits stop execution.
