# Task 08.5 - Autonomous Bounded Research Loop / Subtask 09 - Create bounded-research-loop Skill

## Objective

Create `skills/run-bounded-investigation/SKILL.md` that follows the state machine, uses choose-next-
investigation and experiment-design Skills, invokes Critic before confirmation and emits final
