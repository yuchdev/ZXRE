# Task 08.2 - Interventional Memory Experiments / Subtask 09 - Add synthetic causal-variable scenario

## Objective

Fixture where changing candidate X alters rendered/captured state while animation counter does not;
verify paired trials distinguish causal effect and generate appropriate evidence grade.
