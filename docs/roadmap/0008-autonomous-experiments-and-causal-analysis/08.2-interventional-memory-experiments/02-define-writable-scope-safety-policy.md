# Task 08.2 - Interventional Memory Experiments / Subtask 02 - Define writable-scope safety policy

## Objective

Create `src/zxre/causal/safety.py`. Validate target address/range, maximum bytes per intervention,
ROM exclusion, optional protected/system ranges, allowed value sets and requirement for a stable
restorable snapshot.
