# Task 08.2 - Interventional Memory Experiments / Subtask 05 - Implement paired intervention/control trials

## Objective

Run intervention and no-intervention control from identical snapshot/scenario and compare memory,
screen, trace and stop behavior.
