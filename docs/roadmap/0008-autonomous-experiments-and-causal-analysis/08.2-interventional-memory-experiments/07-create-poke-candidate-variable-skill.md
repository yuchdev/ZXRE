# Task 08.2 - Interventional Memory Experiments / Subtask 07 - Create poke-candidate-variable Skill

## Objective

Create `skills/intervene-on-state-candidate/SKILL.md` requiring safety validation, minimal-value
perturbation, paired control, repeated confirmation and explicit falsification.
