# Task 08.2 - Interventional Memory Experiments / Subtask 01 - Define intervention model

## Objective

Create `src/zxre/causal/intervention.py` and tests. Define `MemoryIntervention`,
`RegisterIntervention`, `InterventionPlan`, `InterventionTrial`, `InterventionResult`,
`InterventionSafetyPolicy`, and expected observation links.
