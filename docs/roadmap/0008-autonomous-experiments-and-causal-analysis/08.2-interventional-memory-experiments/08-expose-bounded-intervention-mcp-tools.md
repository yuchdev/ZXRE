# Task 08.2 - Interventional Memory Experiments / Subtask 08 - Expose bounded intervention MCP tools

## Objective

Add tools for safety-check, compile intervention experiment and run approved plan. Do not expose
unrestricted arbitrary-memory-write autonomous loop.
