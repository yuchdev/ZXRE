# Task 08.2 - Interventional Memory Experiments / Subtask 06 - Implement causal evidence generator

## Objective

Create `src/zxre/causal/evidence.py`. Convert repeatable intervention effects into EvidenceRecords
at `CONTROLLED_INTERVENTION` grade only when reproducibility/safety criteria are met; otherwise emit
weaker/diagnostic evidence.
