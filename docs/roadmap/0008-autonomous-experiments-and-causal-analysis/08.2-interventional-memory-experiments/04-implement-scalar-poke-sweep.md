# Task 08.2 - Interventional Memory Experiments / Subtask 04 - Implement scalar poke sweep

## Objective

Support controlled candidate-value sweeps for 1-byte/2-byte state locations with explicit maximum
trial count and selected values. Record crash/timeout/no-effect outcomes rather than retrying
indefinitely.
