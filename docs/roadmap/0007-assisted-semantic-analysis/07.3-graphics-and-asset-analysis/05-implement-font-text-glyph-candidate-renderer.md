# Task 07.3 - Graphics and Asset Analysis / Subtask 05 - Implement font/text-glyph candidate renderer

## Objective

Create `src/zxre/assets/fonts.py` for 8x8 glyph sheets and address-index mapping.
