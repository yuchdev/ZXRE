# Task 07.3 - Graphics and Asset Analysis / Subtask 04 - Implement sprite-candidate renderer

## Objective

Create `src/zxre/assets/sprites.py`. Render configurable width/height/stride/mask interpretations as
candidate sprite sheets. Keep interpretation parameters explicit.
