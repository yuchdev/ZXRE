# Task 07.3 - Graphics and Asset Analysis / Subtask 03 - Implement tile-sheet renderer

## Objective

Create `src/zxre/assets/tiles.py`. Render arbitrary byte ranges as configurable 8x8 monochrome
tiles, columns/count/stride; produce PNG artifact plus mapping from tile index to address.
