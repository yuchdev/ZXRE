# Task 07.3 - Graphics and Asset Analysis / Subtask 08 - Extend Asset Analyst workflow

## Objective

Update `agents/asset-analyst.md` and create/update `skills/analyze-graphics-region/SKILL.md` to
request deterministic renders first, then perform visual classification with evidence/alternatives.
