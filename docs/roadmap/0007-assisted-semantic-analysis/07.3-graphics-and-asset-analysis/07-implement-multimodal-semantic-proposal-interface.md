# Task 07.3 - Graphics and Asset Analysis / Subtask 07 - Implement multimodal semantic proposal interface

## Objective

Create `src/zxre/semantic/asset_service.py` accepting an agent/model-authored classification such as
player/enemy/font/digit/platform/background, linking rendered artifact and creating an `ASSET_TYPE`
hypothesis. No model-provider code here.
