# Task 07.3 - Graphics and Asset Analysis / Subtask 01 - Define asset-analysis model

## Objective

Create `src/zxre/semantic/assets.py` and tests. Define `AssetCandidate`, `AssetKind`, `AssetLayout`,
`RenderedAsset`, `AssetSemanticProposal`, source range/artifact and evidence refs.
