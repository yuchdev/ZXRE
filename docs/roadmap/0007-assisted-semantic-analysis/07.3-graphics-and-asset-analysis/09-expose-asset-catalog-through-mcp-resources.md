# Task 07.3 - Graphics and Asset Analysis / Subtask 09 - Expose asset catalog through MCP resources

## Objective

Add resources/tools for asset candidates, render artifact refs, source ranges, layout parameters and
semantic hypotheses. Where harness supports image artifacts, expose reference rather than base64
dump.
