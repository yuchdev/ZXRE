# Task 07.1 - Variable and State Discovery / Subtask 01 - Define variable/state candidate model

## Objective

Create `src/zxre/semantic/state.py` and tests. Define `StateCandidate`, `StateCandidateKind`,
`ValueShape`, `AccessPatternSummary`, `StateStructureCandidate`, and semantic-name/type proposals
with hypothesis/evidence refs.
