# Task 07.1 - Variable and State Discovery / Subtask 06 - Implement contiguous/grouped state structure proposals

## Objective

Create `src/zxre/semantic/structures.py`. Suggest grouped ranges when neighboring fields share
access routines/lifecycle, but keep grouping heuristic explicit and hypothesis-backed.
