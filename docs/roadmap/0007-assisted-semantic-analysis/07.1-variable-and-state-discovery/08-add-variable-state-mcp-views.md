# Task 07.1 - Variable and State Discovery / Subtask 08 - Add variable/state MCP views

## Objective

Expose candidate addresses, access summaries, diff intersections, hypotheses and promotion status
