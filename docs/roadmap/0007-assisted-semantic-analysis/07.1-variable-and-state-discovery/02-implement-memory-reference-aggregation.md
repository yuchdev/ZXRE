# Task 07.1 - Variable and State Discovery / Subtask 02 - Implement memory-reference aggregation

## Objective

Create `src/zxre/semantic/state_references.py`. Aggregate static references and runtime access
events by address/range: readers, writers, execution locations, access counts and widths when known.
