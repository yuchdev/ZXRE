# Task 07.1 - Variable and State Discovery / Subtask 07 - Extend test-variable-hypothesis Skill

## Objective

Update `skills/test-variable-hypothesis/SKILL.md` to use reference aggregation, diff candidates,
runtime observations and promotion rules. It may reuse existing experiments but must not
autonomously invent large experiment plans.
