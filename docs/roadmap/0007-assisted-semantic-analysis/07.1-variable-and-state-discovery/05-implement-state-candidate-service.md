# Task 07.1 - Variable and State Discovery / Subtask 05 - Implement state candidate service

## Objective

Create `src/zxre/semantic/state_service.py`. Turn selected address/range plus deterministic
observations into a `VARIABLE_MEANING` or `STRUCTURE` hypothesis, attach evidence and retain
competing meanings.
