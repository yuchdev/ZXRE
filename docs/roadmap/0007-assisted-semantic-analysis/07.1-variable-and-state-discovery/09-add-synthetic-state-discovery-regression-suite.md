# Task 07.1 - Variable and State Discovery / Subtask 09 - Add synthetic state-discovery regression suite

## Objective

Create tests with scripted player-like X/Y/lives/current-room memory patterns via fake
runtime/captures. Verify candidate extraction and evidence handling without hard-coding those
semantic names into deterministic analyzers.
