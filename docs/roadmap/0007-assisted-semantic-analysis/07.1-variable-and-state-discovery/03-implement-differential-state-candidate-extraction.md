# Task 07.1 - Variable and State Discovery / Subtask 03 - Implement differential-state candidate extraction

## Objective

Create `src/zxre/semantic/state_diff.py`. Combine memory diffs across selected captures/scenarios
and support intersection/union queries to identify addresses repeatedly changing under a condition.
No semantic label inference in this module.
