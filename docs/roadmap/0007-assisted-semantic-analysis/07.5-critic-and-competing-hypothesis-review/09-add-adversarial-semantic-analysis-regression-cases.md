# Task 07.5 - Critic and Competing-Hypothesis Review / Subtask 09 - Add adversarial semantic-analysis regression cases

## Objective

Create tests where plausible static pattern suggests wrong routine/variable purpose; verify critic
prechecks/alternative structures prevent automatic confirmation and preserve competing hypotheses.
