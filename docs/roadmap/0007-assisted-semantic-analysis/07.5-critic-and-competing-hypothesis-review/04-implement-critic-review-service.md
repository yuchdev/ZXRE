# Task 07.5 - Critic and Competing-Hypothesis Review / Subtask 04 - Implement Critic review service

## Objective

Create `src/zxre/review/service.py`. Persist critic findings, attach them to hypotheses, optionally
move a hypothesis to contradicted/blocked only through allowed lifecycle/policy operations, and
create follow-up frontier items.
