# Task 07.5 - Critic and Competing-Hypothesis Review / Subtask 01 - Define semantic review model

## Objective

Create `src/zxre/review/model.py`, package init and tests. Define `ReviewId`, `SemanticReview`,
`ReviewFinding`, `ReviewSeverity`, `FindingKind`, and links to hypotheses/evidence/entities.
