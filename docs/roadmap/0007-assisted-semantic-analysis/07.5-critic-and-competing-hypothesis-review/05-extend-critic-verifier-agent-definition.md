# Task 07.5 - Critic and Competing-Hypothesis Review / Subtask 05 - Extend Critic/Verifier agent definition

## Objective

Update `agents/critic-verifier.md` to inspect prechecks, search for alternative interpretations,
explicitly identify circular evidence and ask for the cheapest discriminating evidence without
autonomously executing a new experiment plan.
