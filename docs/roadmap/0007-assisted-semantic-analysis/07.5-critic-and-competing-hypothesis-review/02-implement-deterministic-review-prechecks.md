# Task 07.5 - Critic and Competing-Hypothesis Review / Subtask 02 - Implement deterministic review prechecks

## Objective

Create `src/zxre/review/prechecks.py`. Detect no-evidence hypotheses, evidence cycles/self-
reference, stale/broken sources, confirmation below current policy, duplicated contradictory names
and external-only evidence.
