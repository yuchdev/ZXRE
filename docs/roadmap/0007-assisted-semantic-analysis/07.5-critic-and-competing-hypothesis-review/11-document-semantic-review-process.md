# Task 07.5 - Critic and Competing-Hypothesis Review / Subtask 11 - Document semantic review process

## Objective

Create `docs/analysis/semantic-review.md` covering prechecks, critic responsibilities, competing
hypotheses, frontier feedback and boundary with Milestone 0008 autonomous experiment planning.
