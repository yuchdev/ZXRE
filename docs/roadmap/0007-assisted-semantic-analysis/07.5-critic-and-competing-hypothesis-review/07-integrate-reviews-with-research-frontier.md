# Task 07.5 - Critic and Competing-Hypothesis Review / Subtask 07 - Integrate reviews with research frontier

## Objective

Extend frontier derivation to include unresolved high-severity review findings, missing
discriminators, contradicted confirmed-state candidates and entities whose semantic names block
