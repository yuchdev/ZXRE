# Task 07.4 - Subsystem Map / Subtask 07 - Add subsystem MCP resource

## Objective

Expose compact subsystem graph, members, relationships, evidence/proposal status and unresolved
