# Task 07.4 - Subsystem Map / Subtask 08 - Add synthetic subsystem fixture

## Objective

Create test graph modeling init/input/player/render loop with known call/state relationships; verify
deterministic features and hypothesis-backed clustering APIs.
