# Task 07.4 - Subsystem Map / Subtask 05 - Implement subsystem architecture graph queries

## Objective

Provide queries for members, inter-subsystem calls/data dependencies, confirmed vs proposed members,
shared state and unresolved boundary entities.
