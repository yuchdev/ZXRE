# Task 07.4 - Subsystem Map / Subtask 01 - Define subsystem model

## Objective

Create `src/zxre/semantic/subsystems.py` and tests. Define `SubsystemId`, `Subsystem`,
`SubsystemMembership`, `SubsystemRelationship`, membership status/confidence derived from
