# Task 07.4 - Subsystem Map / Subtask 02 - Define subsystem taxonomy as extensible concepts

## Objective

Provide initial generic concept labels such as input, rendering, audio, entity update, collision,
level/data loading, UI/HUD, initialization/main loop. Do not force every game into a fixed taxonomy.
