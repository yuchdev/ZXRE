# Task 07.4 - Subsystem Map / Subtask 03 - Implement graph-feature aggregation

## Objective

Create `src/zxre/semantic/subsystem_features.py`. Aggregate call graph proximity, shared
variables/data, runtime co-execution and shared asset references for entities; output deterministic
features only.
