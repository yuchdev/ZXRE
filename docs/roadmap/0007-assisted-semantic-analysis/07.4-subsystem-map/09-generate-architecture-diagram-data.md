# Task 07.4 - Subsystem Map / Subtask 09 - Generate architecture diagram data

## Objective

Create `src/zxre/reports/subsystems.py` emitting Mermaid/Graphviz-compatible text or neutral graph
JSON from canonical subsystem state. Avoid making visualization format canonical.
