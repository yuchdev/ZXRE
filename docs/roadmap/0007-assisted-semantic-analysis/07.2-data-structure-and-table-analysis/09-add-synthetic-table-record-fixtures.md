# Task 07.2 - Data Structure and Table Analysis / Subtask 09 - Add synthetic table/record fixtures

## Objective

Create integration tests for direct jump table, pointer table, text table, numeric lookup table and
false-positive random bytes.
