# Task 07.2 - Data Structure and Table Analysis / Subtask 05 - Implement record-layout candidate analyzer

## Objective

Create `src/zxre/semantic/records.py`. Given repeating stride/range, propose field offsets/widths
from recurring reference/access patterns. Record layout remains hypothesis-backed.
