# Task 07.2 - Data Structure and Table Analysis / Subtask 06 - Implement data interpretation service

## Objective

Create `src/zxre/semantic/data_service.py`. Persist interpretations, create hypotheses, link
control-map region/artifacts/evidence and allow competing interpretations for one range.
