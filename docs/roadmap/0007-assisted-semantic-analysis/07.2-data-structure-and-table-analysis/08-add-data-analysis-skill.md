# Task 07.2 - Data Structure and Table Analysis / Subtask 08 - Add data-analysis Skill

## Objective

Create `skills/analyze-data-region/SKILL.md` for structural detection, reference checks, candidate
interpretations, evidence and critic review.
