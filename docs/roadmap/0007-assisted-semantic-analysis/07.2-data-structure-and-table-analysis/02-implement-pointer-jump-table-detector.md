# Task 07.2 - Data Structure and Table Analysis / Subtask 02 - Implement pointer/jump-table detector

## Objective

Create `src/zxre/semantic/pointer_tables.py`. Detect aligned little-endian values pointing into
known code/data ranges, compute target validity ratio and distinguish candidate pointer table vs raw
words. Do not classify semantic role.
