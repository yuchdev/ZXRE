# Task 07.2 - Data Structure and Table Analysis / Subtask 03 - Implement lookup-table pattern analyzer

## Objective

Create `src/zxre/semantic/lookup_tables.py`. Detect small fixed-width numeric tables,
monotonic/periodic sequences, bit masks and repeated stride patterns as structural descriptors.
