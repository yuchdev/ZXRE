# Task 07.2 - Data Structure and Table Analysis / Subtask 04 - Implement text/string detector

## Objective

Create `src/zxre/semantic/text.py`. Identify printable Spectrum/ASCII-like runs and
terminated/fixed-width strings conservatively, preserving bytes/encoding assumptions.
