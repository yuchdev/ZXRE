# Task 07.2 - Data Structure and Table Analysis / Subtask 01 - Define data interpretation model

## Objective

Create `src/zxre/semantic/data.py` and tests. Define `DataInterpretation`, `DataInterpretationKind`,
`TableShape`, `RecordLayoutProposal`, `PointerTargetSummary`, and evidence/hypothesis references.
