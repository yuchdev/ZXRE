# Task 07.0 - Routine Semantic Analysis / Subtask 07 - Add routine semantic MCP/resource views

## Objective

Extend Milestone 0006 MCP tools/resources with bounded routine semantic summary, name proposals,
interface facts and promotion status. Avoid dumping full disassembly by default.
