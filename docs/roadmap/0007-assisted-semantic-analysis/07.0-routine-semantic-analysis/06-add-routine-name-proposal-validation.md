# Task 07.0 - Routine Semantic Analysis / Subtask 06 - Add routine-name proposal validation

## Objective

Implement validation ensuring proposed names are unique enough, syntactically suitable for future
assembler symbols, and not promoted automatically. Mechanical labels remain available alongside
