# Task 07.0 - Routine Semantic Analysis / Subtask 03 - Derive deterministic routine interface facts

## Objective

Create `src/zxre/semantic/routine_facts.py`. Infer only mechanically supportable facts such as
registers read-before-write, registers definitely written, stack behavior where static flow permits,
direct memory addresses read/written and direct callees. Mark unknown/ambiguous paths explicitly.
