# Task 07.0 - Routine Semantic Analysis / Subtask 02 - Implement routine context aggregator

## Objective

Create `src/zxre/semantic/routine_context.py`. Gather bounded context for one routine candidate:
instructions, callers/callees, direct references, control-flow exits, runtime coverage, memory
reads/writes, symbols, hypotheses and evidence. Return structured context for agents/resources
rather than prompt-formatted prose.
