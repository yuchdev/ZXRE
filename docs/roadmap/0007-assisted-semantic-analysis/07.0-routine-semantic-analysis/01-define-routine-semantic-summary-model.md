# Task 07.0 - Routine Semantic Analysis / Subtask 01 - Define routine semantic summary model

## Objective

Create `src/zxre/semantic/routines.py`, `src/zxre/semantic/__init__.py`, and tests. Define
`RoutineSemanticSummary`, `RoutineInterfaceSummary`, `RegisterRole`, `MemoryEffectSummary`,
`SemanticNameProposal`, and source evidence/hypothesis references. Keep summary state separate from
confirmed knowledge entities.
