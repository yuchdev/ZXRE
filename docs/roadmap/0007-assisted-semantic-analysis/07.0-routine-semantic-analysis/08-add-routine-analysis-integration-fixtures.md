# Task 07.0 - Routine Semantic Analysis / Subtask 08 - Add routine-analysis integration fixtures

## Objective

Create `tests/integration/test_semantic_routine_analysis.py` using synthetic routines with known
static/runtime behavior. Verify deterministic facts, proposal creation, evidence linkage and no
confirmation without policy.
