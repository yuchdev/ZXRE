# Task 07.0 - Routine Semantic Analysis / Subtask 04 - Implement routine semantic proposal service

## Objective

Create `src/zxre/semantic/routine_service.py`. Accept agent/human proposals for routine
purpose/name/interface interpretation and create hypotheses plus evidence links; do not update
confirmed entity names directly.
