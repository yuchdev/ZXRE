# Task 07.0 - Routine Semantic Analysis / Subtask 09 - Document routine semantic workflow

## Objective

Create `docs/analysis/routine-semantics.md` with fact/proposal/confirmation separation, interface
limitations and worked synthetic example.
