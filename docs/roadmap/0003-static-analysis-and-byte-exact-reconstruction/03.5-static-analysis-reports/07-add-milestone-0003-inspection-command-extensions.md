# Task 03.5 - Static Analysis Reports / Subtask 07 - Add Milestone 0003 inspection command extensions

## Objective

Extend CLI only as a thin view, likely:

## Implementation specification

- `zxre disasm summary PROJECT [--json]`
- `zxre control list PROJECT [--json]`
- `zxre reconstruct verify PROJECT [--json]`
- `zxre report static PROJECT [--output ...]`

Implement command modules/tests consistent with Task 01.4 CLI conventions.

Do not add interactive editor/TUI.
