# Task 03.5 - Static Analysis Reports / Subtask 04 - Implement machine-readable report

## Objective

Create `src/zxre/reports/static_json.py`.

## Implementation specification

Emit versioned JSON containing the same summary facts and references to canonical artifact IDs.

Do not duplicate full disassembly or trace-sized data into reports.
