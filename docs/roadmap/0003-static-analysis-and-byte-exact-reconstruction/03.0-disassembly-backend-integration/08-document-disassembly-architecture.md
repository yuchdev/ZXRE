# Task 03.0 - Disassembly Backend Integration / Subtask 08 - Document disassembly architecture

## Objective

Create `docs/architecture/disassembly.md`.
...
- optional SkoolKit adapter;
- exact-byte preservation;
- alias/undocumented opcode policy;
- why semantic function names and code/data classification are separate tasks.
