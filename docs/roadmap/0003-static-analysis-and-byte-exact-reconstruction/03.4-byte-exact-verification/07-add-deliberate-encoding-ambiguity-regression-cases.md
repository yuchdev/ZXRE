# Task 03.4 - Byte-Exact Verification / Subtask 07 - Add deliberate encoding-ambiguity regression cases

## Objective

Create generated fixtures testing byte aliases/assembler normalization.

## Implementation specification

Examples:
- instructions with multiple legal opcode encodings where applicable;
- undocumented aliases;
- directives whose assembler may normalize representation.

Policy:
if textual instruction cannot reproduce exact original bytes, generator must use explicit byte
directives.

Tests prove the fallback preserves exact bytes.
