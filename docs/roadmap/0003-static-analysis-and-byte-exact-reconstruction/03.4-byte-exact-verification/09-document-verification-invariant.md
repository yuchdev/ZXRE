# Task 03.4 - Byte-Exact Verification / Subtask 09 - Document verification invariant

## Objective

Create `docs/architecture/byte-exact-verification.md`.

## Implementation specification

Document:
- why byte equality is the Milestone 0003 ground truth;
- exact vs layout vs assembly failure;
- fallback-to-byte directives;
- treatment of nondeterministic assembler metadata;
- required verification before any later semantic source promotion.
