# Task 03.4 - Byte-Exact Verification / Subtask 02 - Implement reference assembler adapter

## Objective

Implement one adapter matching Task 03.3's selected dialect.

## Implementation specification

Possible locations:
- `src/zxre/adapters/sjasmplus/`
or
- `src/zxre/adapters/skoolkit/assembler.py`.

Requirements:
- executable discovery/config override;
- version capture;
- deterministic argv;
- temp/output cleanup;
- structured errors;
- optional external dependency with skipped tests when unavailable.

Document exact supported version expectations if syntax varies.
