# Task 03.4 - Byte-Exact Verification / Subtask 03 - Define verification model
...
- `src/zxre/verify/model.py`
- `tests/verify/test_model.py`
...
Include compared address range and source/rebuilt artifact IDs.
