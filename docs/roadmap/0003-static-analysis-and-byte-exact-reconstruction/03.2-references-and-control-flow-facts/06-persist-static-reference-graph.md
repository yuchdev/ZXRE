# Task 03.2 - References and Control-Flow Facts / Subtask 06 - Persist static reference graph

## Objective

Create `src/zxre/analysis/static_serialization.py`.
...
- routine candidates;
- diagnostics;
- source disassembly/control-map version references.

Suggested path:
`analysis/static-flow.json`.

Versioned deterministic ordering required.
