# Task 03.2 - References and Control-Flow Facts / Subtask 07 - Implement static-analysis query service

## Objective

Create `src/zxre/analysis/static_service.py`.

## Implementation specification

Queries:
- references to/from address;
- callers of routine candidate;
- callees/direct targets from routine;
- basic block containing address;
- routine candidate containing/address-start;
- unresolved indirect exits.

Tests:
project reopen/query consistency.
