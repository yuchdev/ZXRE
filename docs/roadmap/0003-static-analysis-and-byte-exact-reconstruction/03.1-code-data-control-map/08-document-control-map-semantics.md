# Task 03.1 - Code/Data Control Map / Subtask 08 - Document control-map semantics

## Objective

Create `docs/architecture/control-map.md`.
...
- origin/precedence;
- overlap rules;
- code vs semantic meaning distinction;
- how future runtime coverage may refine maps;
- how control map drives source reconstruction;
- optional SkoolKit interoperability.
