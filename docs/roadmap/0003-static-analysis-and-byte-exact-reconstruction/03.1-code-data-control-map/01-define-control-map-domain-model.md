# Task 03.1 - Code/Data Control Map / Subtask 01 - Define control-map domain model
...
- `src/zxre/control/model.py`
- `src/zxre/control/__init__.py`
...
- address range;
- kind;
- origin (`USER`, `GENERATED`, `IMPORTED`);
- optional source reference;
- optional deterministic formatting parameters;
- optional comment/label metadata separate from semantics.

Rules:
- no overlapping active regions unless precedence policy is explicit;
- gaps remain `UNKNOWN`;
- half-open address semantics.
