# Task 03.1 - Code/Data Control Map / Subtask 05 - Persist control map

## Objective

Create `src/zxre/control/serialization.py`.

## Implementation specification

Suggested project path:
`analysis/control-map.json`.

Requirements:
- versioned format;
- deterministic region ordering;
- origin/source metadata;
- comments/formatting options;
- no hidden auto-generation on load.

Tests:
round-trip, incompatible version, overlap caught after load.
