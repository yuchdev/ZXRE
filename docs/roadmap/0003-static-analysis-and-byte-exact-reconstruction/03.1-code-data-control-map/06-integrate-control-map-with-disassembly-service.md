# Task 03.1 - Code/Data Control Map / Subtask 06 - Integrate control map with disassembly service

## Objective

Update `src/zxre/disasm/service.py`.

## Implementation specification

Add operation to disassemble according to `ControlMap`:
- decode only `CODE` regions;
- preserve other regions as typed non-instruction blocks;
- report decode errors tied to region/address;
- do not auto-promote failed code to bytes unless an explicit option/policy says so.

Add tests with mixed CODE/BYTES/TEXT regions.
