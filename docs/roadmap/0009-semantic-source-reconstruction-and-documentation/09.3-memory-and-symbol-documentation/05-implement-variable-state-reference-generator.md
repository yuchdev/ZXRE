# Task 09.3 - Memory and Symbol Documentation / Subtask 05 - Implement variable/state reference generator

## Objective

Create `src/zxre/docs/state.py`. Summarize confirmed/candidate variables and structures with
address/width/accessors/evidence and status.
