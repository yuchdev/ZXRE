# Task 09.3 - Memory and Symbol Documentation / Subtask 02 - Implement memory-map document generator

## Objective

Create `src/zxre/docs/memory_map.py`. Generate Markdown tables/sections for ROM/RAM, control-map
regions, confirmed/proposed variables/data/assets and unresolved gaps with stable ordering.
