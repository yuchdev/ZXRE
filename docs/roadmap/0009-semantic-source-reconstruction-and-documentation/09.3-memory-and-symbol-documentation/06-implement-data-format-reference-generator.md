# Task 09.3 - Memory and Symbol Documentation / Subtask 06 - Implement data-format reference generator

## Objective

Create `src/zxre/docs/data_formats.py` for confirmed table/record/text/asset interpretations and
exact source ranges.
