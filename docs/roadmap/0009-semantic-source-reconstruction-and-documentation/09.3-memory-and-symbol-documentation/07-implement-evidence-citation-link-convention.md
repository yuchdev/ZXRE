# Task 09.3 - Memory and Symbol Documentation / Subtask 07 - Implement evidence citation/link convention

## Objective

Create shared helper ensuring docs link to stable project IDs/artifact reports rather than embedding
unverifiable agent prose. For generated repo docs, use deterministic relative paths/IDs.
