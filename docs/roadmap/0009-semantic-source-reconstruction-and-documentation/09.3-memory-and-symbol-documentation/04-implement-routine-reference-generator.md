# Task 09.3 - Memory and Symbol Documentation / Subtask 04 - Implement routine reference generator

## Objective

Create `src/zxre/docs/routines.py`. Summarize confirmed routine semantics, interface facts,
callers/callees, side effects, module and unresolved questions.
