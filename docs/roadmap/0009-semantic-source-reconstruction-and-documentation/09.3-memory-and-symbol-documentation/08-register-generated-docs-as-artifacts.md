# Task 09.3 - Memory and Symbol Documentation / Subtask 08 - Register generated docs as artifacts

## Objective

Create `src/zxre/docs/service.py`. Generate docs from project state, register artifact/provenance
and optionally materialize under project `docs/` tree.
