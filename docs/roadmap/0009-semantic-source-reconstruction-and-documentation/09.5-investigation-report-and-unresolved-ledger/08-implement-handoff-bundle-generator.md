# Task 09.5 - Investigation Report and Unresolved Ledger / Subtask 08 - Implement handoff bundle generator

## Objective

Create `src/zxre/docs/handoff.py` producing Markdown report plus references/manifests to semantic
source, verification, generated docs and unresolved ledger. Avoid copying copyrighted binary assets
unnecessarily.
