# Task 09.5 - Investigation Report and Unresolved Ledger / Subtask 01 - Define investigation report model

## Objective

Create `src/zxre/docs/investigation.py` and tests. Define `InvestigationReport`, `FindingSummary`,
`UnresolvedItem`, `DeferredItem`, `ReproductionStep`, and source IDs.
