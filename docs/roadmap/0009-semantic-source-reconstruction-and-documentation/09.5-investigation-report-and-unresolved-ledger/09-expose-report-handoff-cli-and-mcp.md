# Task 09.5 - Investigation Report and Unresolved Ledger / Subtask 09 - Expose report/handoff CLI and MCP

## Objective

Add `zxre report investigation`, `zxre handoff build` and corresponding bounded MCP resources/tools.
