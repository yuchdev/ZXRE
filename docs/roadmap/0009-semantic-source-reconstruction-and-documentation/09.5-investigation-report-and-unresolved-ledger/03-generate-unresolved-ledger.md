# Task 09.5 - Investigation Report and Unresolved Ledger / Subtask 03 - Generate unresolved ledger

## Objective

Create `src/zxre/docs/unresolved.py`. Aggregate open/contradicted hypotheses, critic findings,
frontier items, unknown control ranges, unresolved indirect flow, failed experiments and blocked
promotion decisions.
