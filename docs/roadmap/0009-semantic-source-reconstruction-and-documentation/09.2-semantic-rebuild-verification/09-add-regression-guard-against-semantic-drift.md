# Task 09.2 - Semantic Rebuild Verification / Subtask 09 - Add regression guard against semantic drift

## Objective

Create test that intentionally alters instruction/data directive and confirms verification fails
with address-level attribution.
