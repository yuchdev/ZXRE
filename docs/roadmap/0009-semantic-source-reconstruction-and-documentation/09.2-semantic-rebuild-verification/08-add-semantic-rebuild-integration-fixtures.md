# Task 09.2 - Semantic Rebuild Verification / Subtask 08 - Add semantic rebuild integration fixtures

## Objective

Use synthetic semantic names/modules over known exact-rebuild fixture; verify module
split/comment/name changes remain byte-exact.
