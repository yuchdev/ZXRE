# Task 09.2 - Semantic Rebuild Verification / Subtask 06 - Implement mismatch attribution

## Objective

Create `src/zxre/semantic_source/mismatch.py`. Attribute mismatches to module/source line/address,
show expected/actual bytes and nearest semantic symbol.
