# Task 09.2 - Semantic Rebuild Verification / Subtask 03 - Implement semantic-tree build service

## Objective

Create `src/zxre/semantic_source/build.py` to materialize source tree in temp workspace, invoke
assembler, capture maps/binaries and register artifacts/provenance.
