# Task 09.2 - Semantic Rebuild Verification / Subtask 04 - Implement exact semantic-vs-source comparison

## Objective

Compare rebuilt semantic output against original analyzed memory using existing byte comparator.
Default acceptance is byte-exact.
