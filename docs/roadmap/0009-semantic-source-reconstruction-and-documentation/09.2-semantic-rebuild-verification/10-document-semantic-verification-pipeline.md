# Task 09.2 - Semantic Rebuild Verification / Subtask 10 - Document semantic verification pipeline

## Objective

Create `docs/reconstruction/semantic-verification.md` covering exact default, transformations,
mismatch attribution and relationship to Milestone 0003 invariant.
