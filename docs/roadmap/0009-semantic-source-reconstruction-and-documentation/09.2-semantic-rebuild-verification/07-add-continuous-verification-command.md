# Task 09.2 - Semantic Rebuild Verification / Subtask 07 - Add continuous verification command

## Objective

Extend CLI/MCP with e.g. `zxre semantic verify PROJECT [--json]`, returning
exact/layout/transformation status and artifact refs.
