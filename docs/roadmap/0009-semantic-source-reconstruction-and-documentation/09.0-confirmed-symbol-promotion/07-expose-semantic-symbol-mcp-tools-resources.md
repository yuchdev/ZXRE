# Task 09.0 - Confirmed-Symbol Promotion / Subtask 07 - Expose semantic-symbol MCP tools/resources

## Objective

Add read/list/promote/status tools/resources. Promotion tool must call policy-backed service; no
direct arbitrary rename mutation.
