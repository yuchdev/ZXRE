# Task 09.0 - Confirmed-Symbol Promotion / Subtask 06 - Implement promotion transaction service

## Objective

Create `src/zxre/semantic_source/service.py`. Promote confirmed knowledge into overlay atomically,
preserving mechanical label, semantic symbol, source hypothesis, evidence and policy audit IDs.
