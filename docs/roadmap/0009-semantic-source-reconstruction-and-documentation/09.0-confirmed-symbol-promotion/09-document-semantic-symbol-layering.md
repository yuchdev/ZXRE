# Task 09.0 - Confirmed-Symbol Promotion / Subtask 09 - Document semantic symbol layering

## Objective

Create `docs/reconstruction/semantic-symbols.md` with mechanical vs semantic symbols, promotion
flow, conflict rules and provenance.
