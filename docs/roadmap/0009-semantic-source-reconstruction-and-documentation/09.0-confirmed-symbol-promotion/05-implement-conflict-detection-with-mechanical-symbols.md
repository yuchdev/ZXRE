# Task 09.0 - Confirmed-Symbol Promotion / Subtask 05 - Implement conflict detection with mechanical symbols

## Objective

Create `src/zxre/semantic_source/conflicts.py`. Detect duplicate names, one address with
incompatible promoted meanings, overlapping semantic constants/ranges and conflicts with assembler-
