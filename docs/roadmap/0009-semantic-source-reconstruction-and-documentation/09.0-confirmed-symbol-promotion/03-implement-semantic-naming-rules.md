# Task 09.0 - Confirmed-Symbol Promotion / Subtask 03 - Implement semantic naming rules

## Objective

Create `src/zxre/semantic_source/naming.py`. Normalize assembler-safe names, namespace collisions,
local/global label policy and deterministic fallback suffixes without mutating canonical confirmed
semantic text.
