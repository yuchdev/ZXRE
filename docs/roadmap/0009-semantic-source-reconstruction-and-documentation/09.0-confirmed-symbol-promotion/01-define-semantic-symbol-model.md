# Task 09.0 - Confirmed-Symbol Promotion / Subtask 01 - Define semantic symbol model

## Objective

Create `src/zxre/semantic_source/model.py`, package init and tests. Define `SemanticSymbolId`,
`SemanticSymbol`, `SemanticSymbolKind`, `SemanticComment`, `SemanticConstant`, `SemanticAnnotation`,
and links to confirmed hypothesis/evidence/entity IDs.
