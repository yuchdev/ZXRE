# Task 09.0 - Confirmed-Symbol Promotion / Subtask 04 - Implement symbol overlay store

## Objective

Create `src/zxre/semantic_source/store.py` and tests. Persist semantic symbols/comments/constants
separately from mechanical symbols, with versioned serialization and immutable promotion provenance.
