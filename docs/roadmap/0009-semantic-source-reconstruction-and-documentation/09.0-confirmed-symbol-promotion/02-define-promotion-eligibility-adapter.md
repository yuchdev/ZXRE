# Task 09.0 - Confirmed-Symbol Promotion / Subtask 02 - Define promotion eligibility adapter

## Objective

Create `src/zxre/semantic_source/promotion.py`. Accept only entities/hypotheses already confirmed by
Milestone 0005 policy. Reject proposed/supported-but-unconfirmed names and stale evidence.
