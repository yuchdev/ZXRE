# Task 09.4 - Architecture and Subsystem Documentation / Subtask 03 - Generate main-loop/execution-flow document

## Objective

Create `src/zxre/docs/execution_flow.py`. Describe confirmed entry/bootstrap/main-loop flow using
routine/control-flow/runtime evidence and diagrams where available.
