# Task 09.4 - Architecture and Subsystem Documentation / Subtask 10 - Document architecture-doc generation

## Objective

Create `docs/reconstruction/architecture-docs.md` covering projections, uncertainty rendering,
