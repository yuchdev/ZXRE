# Task 09.4 - Architecture and Subsystem Documentation / Subtask 06 - Generate sound/level/other subsystem documents

## Objective

Use generic per-subsystem generator so discovered audio/level/UI/etc. can be documented without a
hard-coded game architecture.
