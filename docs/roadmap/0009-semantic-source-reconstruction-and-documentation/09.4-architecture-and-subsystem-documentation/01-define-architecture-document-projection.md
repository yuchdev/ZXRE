# Task 09.4 - Architecture and Subsystem Documentation / Subtask 01 - Define architecture-document projection

## Objective

Create `src/zxre/docs/architecture_projection.py` and tests. Project subsystem graph, routines,
state, assets, call/data dependencies and uncertainty/status into a structured documentation model.
