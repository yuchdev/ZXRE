# Task 09.1 - Source Module Reconstruction / Subtask 01 - Define semantic source tree model

## Objective

Create `src/zxre/semantic_source/tree.py` and tests. Define `SemanticSourceTree`, `SemanticModule`,
`ModuleMember`, `SourceSection`, and mapping back to lossless source units/address ranges.
