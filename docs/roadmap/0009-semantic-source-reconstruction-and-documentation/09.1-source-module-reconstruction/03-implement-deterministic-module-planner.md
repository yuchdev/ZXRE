# Task 09.1 - Source Module Reconstruction / Subtask 03 - Implement deterministic module planner

## Objective

Create `src/zxre/semantic_source/planner.py`. Given confirmed/provisionally accepted boundaries,
assign routines/data to modules while preserving source order/origin requirements and generating
stable filenames.
