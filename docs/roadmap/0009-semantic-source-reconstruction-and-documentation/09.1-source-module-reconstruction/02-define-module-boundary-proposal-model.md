# Task 09.1 - Source Module Reconstruction / Subtask 02 - Define module-boundary proposal model

## Objective

Create `src/zxre/semantic_source/modules.py`. Support module proposals from confirmed subsystem
membership, routine groups, data ownership and user decisions; keep unconfirmed boundaries
