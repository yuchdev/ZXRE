# Task 05.2 - Hypothesis Lifecycle / Subtask 06 - Implement supersession and revision history

## Objective

Create `src/zxre/hypothesis/revision.py`. When wording/target materially changes, create a successor
hypothesis with `SUPERSEDES` linkage rather than mutating history. Preserve original proposer/source
metadata.
