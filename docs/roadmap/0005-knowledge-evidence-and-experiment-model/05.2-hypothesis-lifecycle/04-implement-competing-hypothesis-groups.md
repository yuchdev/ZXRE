# Task 05.2 - Hypothesis Lifecycle / Subtask 04 - Implement competing-hypothesis groups

## Objective

Create `src/zxre/hypothesis/competition.py`. Define `HypothesisGroupId` and grouping APIs for
mutually exclusive or alternative interpretations. Support one active/confirmed member while
preserving rejected/superseded alternatives and evidence history.
