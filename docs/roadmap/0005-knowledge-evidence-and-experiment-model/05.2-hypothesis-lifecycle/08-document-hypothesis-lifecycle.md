# Task 05.2 - Hypothesis Lifecycle / Subtask 08 - Document hypothesis lifecycle

## Objective

Create `docs/architecture/hypotheses.md` with status diagram, evidence links, competing hypotheses,
supersession and distinction between supported and confirmed.
