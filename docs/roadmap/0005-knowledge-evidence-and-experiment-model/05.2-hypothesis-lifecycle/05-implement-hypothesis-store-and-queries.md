# Task 05.2 - Hypothesis Lifecycle / Subtask 05 - Implement hypothesis store and queries

## Objective

Create `src/zxre/hypothesis/store.py` and tests. Support add/get/list, target/entity/address lookup,
open hypotheses, competing groups, lifecycle transitions and evidence attachments.
