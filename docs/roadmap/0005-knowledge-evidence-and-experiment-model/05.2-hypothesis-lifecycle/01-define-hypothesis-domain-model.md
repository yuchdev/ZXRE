# Task 05.2 - Hypothesis Lifecycle / Subtask 01 - Define hypothesis domain model

## Objective

Create `src/zxre/hypothesis/model.py`, package init and tests. Define `HypothesisId`, `Hypothesis`,
`HypothesisStatus`, `HypothesisKind`, `HypothesisTarget`, and `HypothesisStatement`. Kinds may
include `ENTITY_ROLE`, `VARIABLE_MEANING`, `ROUTINE_PURPOSE`, `DATA_FORMAT`, `RELATIONSHIP`,
`ENTRY_POINT`, `ASSET_TYPE`, `OTHER`.
