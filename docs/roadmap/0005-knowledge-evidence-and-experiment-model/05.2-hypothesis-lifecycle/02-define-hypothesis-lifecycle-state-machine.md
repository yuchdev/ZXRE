# Task 05.2 - Hypothesis Lifecycle / Subtask 02 - Define hypothesis lifecycle state machine

## Objective

Create `src/zxre/hypothesis/lifecycle.py` and tests. Allowed statuses: `PROPOSED`, `SUPPORTED`,
`CONTRADICTED`, `REJECTED`, `SUPERSEDED`, `CONFIRMED`. Define valid transitions explicitly and
reject illegal jumps unless an administrative override path is deliberately modeled.
