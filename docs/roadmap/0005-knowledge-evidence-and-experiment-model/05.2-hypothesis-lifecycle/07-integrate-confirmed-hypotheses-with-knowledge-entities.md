# Task 05.2 - Hypothesis Lifecycle / Subtask 07 - Integrate confirmed hypotheses with knowledge entities

## Objective

Create `src/zxre/hypothesis/promotion_hooks.py`. Provide controlled hooks that may request updates
to knowledge entities/relationships when a hypothesis becomes confirmed. Do not apply promotion
automatically yet; Task 05.3 owns promotion policy.
