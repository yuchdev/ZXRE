# Task 05.4 - Experiment Specification and Results / Subtask 03 - Define stimulus/intervention model

## Objective

Create `src/zxre/experiment/actions.py`. Define actions for input scenario execution, memory
write/poke, register write, run/step, breakpoint/watchpoint setup, wait, capture and trace
start/stop. Keep actions generic over RuntimeService.
