# Task 05.4 - Experiment Specification and Results / Subtask 07 - Link experiment results to evidence and hypotheses

## Objective

Create `src/zxre/experiment/evidence.py`. Convert concrete observations/results into EvidenceRecords
and attach them to hypotheses only when caller explicitly requests linkage. Preserve experiment ID
as provenance.
