# Task 05.4 - Experiment Specification and Results / Subtask 02 - Define setup and starting-state model

## Objective

Create `src/zxre/experiment/setup.py`. Model source snapshot, platform, runtime backend
requirements/capabilities, initial memory/register constraints, input scenario reference and
