# Task 05.4 - Experiment Specification and Results / Subtask 01 - Define experiment domain model

## Objective

Create `src/zxre/experiment/model.py`, package init and tests. Define `ExperimentId`, `Experiment`,
`ExperimentStatus`, `ExperimentPurpose`, `ExperimentStep`, `ExperimentObservation`,
