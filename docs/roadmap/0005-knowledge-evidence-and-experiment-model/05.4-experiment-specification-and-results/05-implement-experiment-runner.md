# Task 05.4 - Experiment Specification and Results / Subtask 05 - Implement experiment runner

## Objective

Create `src/zxre/experiment/runner.py`. Execute experiment steps through
RuntimeService/Input/Trace/Capture services from a reproducible starting snapshot. Ensure cleanup,
timeouts, breakpoint removal and state-capture provenance. Return structured result even on partial
failure.
