# Task 05.0 - Knowledge Entities and Relationships / Subtask 05 - Implement knowledge graph store

## Objective

Create `src/zxre/knowledge/store.py` and `tests/knowledge/test_store.py`. Implement
add/update/remove/get/list entities, add/remove/list relationships, reverse relationship queries,
address/range lookup and referential-integrity checks. Use a simple versioned project-local store
first; do not introduce a graph database.
