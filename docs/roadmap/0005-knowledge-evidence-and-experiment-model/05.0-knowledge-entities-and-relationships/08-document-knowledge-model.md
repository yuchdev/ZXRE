# Task 05.0 - Knowledge Entities and Relationships / Subtask 08 - Document knowledge model

## Objective

Create `docs/architecture/knowledge-model.md`. Document entity kinds, relationship kinds, identity,
deterministic vs semantic relationships, merge/alias behavior, and how evidence/hypothesis layers
attach later.
