# Task 05.0 - Knowledge Entities and Relationships / Subtask 02 - Define routine, variable and data-block entities

## Objective

Create `src/zxre/knowledge/entities.py` and tests. Define typed entities such as `RoutineEntity`,
`VariableEntity`, `DataBlockEntity`, and `StructureEntity`. Fields should reference address/range,
platform, optional static-analysis candidate IDs, size/type hints, and existing symbols. Do not add
confidence scores directly to entities.
