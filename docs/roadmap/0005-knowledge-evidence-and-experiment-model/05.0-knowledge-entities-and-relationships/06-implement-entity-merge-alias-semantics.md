# Task 05.0 - Knowledge Entities and Relationships / Subtask 06 - Implement entity merge/alias semantics

## Objective

Create `src/zxre/knowledge/merge.py`. Support deliberate merge/alias workflows when two discovered
entities later prove identical. Preserve historical IDs through alias/supersession metadata and
prevent silent destructive collapse. Tests cover merge conflicts and relationship rewiring.
