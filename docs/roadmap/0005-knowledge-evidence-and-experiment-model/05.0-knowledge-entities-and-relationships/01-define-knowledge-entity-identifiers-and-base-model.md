# Task 05.0 - Knowledge Entities and Relationships / Subtask 01 - Define knowledge entity identifiers and base model

## Objective

Create `src/zxre/knowledge/model.py`, `src/zxre/knowledge/__init__.py`, and
`tests/knowledge/test_model.py`. Define `KnowledgeEntityId`, `KnowledgeEntity`,
`KnowledgeEntityKind`, `KnowledgeStatus`, and shared metadata fields. Kinds should include
`ROUTINE`, `VARIABLE`, `DATA_BLOCK`, `ASSET`, `SYMBOL`, `CONCEPT`, `STRUCTURE`, and `OTHER`. Keep
entity identity stable and independent from display names.
