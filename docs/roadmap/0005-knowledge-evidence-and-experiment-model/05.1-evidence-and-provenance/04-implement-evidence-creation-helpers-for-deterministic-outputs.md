# Task 05.1 - Evidence and Provenance / Subtask 04 - Implement evidence creation helpers for deterministic outputs

## Objective

Create `src/zxre/evidence/from_deterministic.py`. Provide helpers that convert existing outputs into
evidence records: static reference, runtime trace observation, memory diff, screenshot/capture,
byte-exact verification and runtime-control refinement. Helpers must not assign semantic
conclusions.
