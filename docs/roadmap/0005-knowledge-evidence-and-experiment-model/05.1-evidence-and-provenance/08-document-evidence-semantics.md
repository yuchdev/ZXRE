# Task 05.1 - Evidence and Provenance / Subtask 08 - Document evidence semantics

## Objective

Create `docs/architecture/evidence.md`. Document evidence vs provenance vs claim, immutable source
references, human/external evidence, deterministic observation helpers and why evidence does not
equal truth.
