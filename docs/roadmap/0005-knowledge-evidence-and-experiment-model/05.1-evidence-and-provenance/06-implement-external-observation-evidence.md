# Task 05.1 - Evidence and Provenance / Subtask 06 - Implement external observation evidence

## Objective

Integrate Milestone 0004 external debugger import metadata. Create `src/zxre/evidence/external.py`
if needed. Imported observations must retain external integration ID and reproducibility
limitations; they cannot masquerade as ZXRE-recorded runtime evidence.
