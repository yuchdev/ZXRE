# Task 05.1 - Evidence and Provenance / Subtask 07 - Define evidence serialization and integrity checks

## Objective

Create `src/zxre/evidence/serialization.py` and `src/zxre/evidence/verify.py`. Use versioned
deterministic serialization and verify all artifact/entity/source references resolve. Tests cover
missing source artifact, stale entity alias and corrupted evidence record.
