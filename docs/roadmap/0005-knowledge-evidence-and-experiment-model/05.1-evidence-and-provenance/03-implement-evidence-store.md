# Task 05.1 - Evidence and Provenance / Subtask 03 - Implement evidence store

## Objective

Create `src/zxre/evidence/store.py` and tests. Support add/get/list evidence, query by kind, source
artifact, entity, address/range and hypothesis/claim attachment. Evidence records should be append-
oriented; edits to meaning create new records or supersession links rather than mutating historical
observation text silently.
