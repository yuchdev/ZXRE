# Task 05.5 - Research Frontier Queries / Subtask 05 - Define deterministic priority signals

## Objective

Create `src/zxre/frontier/priority.py`. Compute non-LLM signals such as number of dependent
entities/hypotheses, call/reference centrality, address-range size, conflict severity, promotion-
blocking status, available experiment prerequisites, and estimated deterministic tool cost class.
