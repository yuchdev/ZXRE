# Task 05.5 - Research Frontier Queries / Subtask 06 - Implement frontier service and filters

## Objective

Create `src/zxre/frontier/service.py`. Query all/open/blocked/high-impact items; filter by
address/entity/hypothesis/category; sort by configured deterministic priority tuple. Do not call
models.
