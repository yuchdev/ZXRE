# Task 05.5 - Research Frontier Queries / Subtask 08 - Add frontier report and CLI view

## Objective

Create Markdown/JSON report plus thin CLI, e.g. `zxre frontier list PROJECT [--status ...]
[--json]`. Show confirmed/likely/open/blocked items and priority signals without claiming an
