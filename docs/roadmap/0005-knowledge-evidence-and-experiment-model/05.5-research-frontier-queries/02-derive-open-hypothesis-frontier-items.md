# Task 05.5 - Research Frontier Queries / Subtask 02 - Derive open hypothesis frontier items

## Objective

Create `src/zxre/frontier/from_hypotheses.py`. Emit items for proposed/supported/contradicted
hypotheses, competing groups without resolution, and confirmation blocked by missing evidence.
Include required evidence grade/rule reasons where available.
