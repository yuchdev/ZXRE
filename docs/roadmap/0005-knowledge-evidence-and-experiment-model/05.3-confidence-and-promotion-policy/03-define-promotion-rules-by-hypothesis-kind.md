# Task 05.3 - Confidence and Promotion Policy / Subtask 03 - Define promotion rules by hypothesis kind

## Objective

Create `src/zxre/policy/promotion.py`. Define configurable minimum promotion rules, e.g. variable
meaning may require controlled intervention or multiple independent dynamic correlations; entry-
point confirmation may accept deterministic execution observation; semantic routine purpose may
require stronger mixed evidence. Keep rules explicit and testable.
