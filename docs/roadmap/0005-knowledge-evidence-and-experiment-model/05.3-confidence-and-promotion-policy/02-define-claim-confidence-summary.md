# Task 05.3 - Confidence and Promotion Policy / Subtask 02 - Define claim confidence summary

## Objective

Create `src/zxre/policy/confidence.py`. Implement derived confidence summary from attached evidence:
strongest grade, support/contradiction counts, reproducibility flags and unresolved conflicts. Do
not use floating-point probability as the canonical policy input.
