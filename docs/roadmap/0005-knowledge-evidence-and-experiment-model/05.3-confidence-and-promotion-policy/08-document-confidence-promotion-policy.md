# Task 05.3 - Confidence and Promotion Policy / Subtask 08 - Document confidence/promotion policy

## Objective

Create `docs/architecture/confidence-and-promotion.md` including grade table, per-claim promotion
examples, contradiction behavior, manual override semantics and rule-versioning strategy.
