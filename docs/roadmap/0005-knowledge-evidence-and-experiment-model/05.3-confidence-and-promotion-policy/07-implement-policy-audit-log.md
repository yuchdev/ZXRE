# Task 05.3 - Confidence and Promotion Policy / Subtask 07 - Implement policy audit log

## Objective

Create `src/zxre/policy/audit.py`. Record evaluations, promotions, rejections and manual overrides
with actor/source, rule version and reason. Manual override must be explicit and visibly
distinguishable from policy-confirmed promotion.
