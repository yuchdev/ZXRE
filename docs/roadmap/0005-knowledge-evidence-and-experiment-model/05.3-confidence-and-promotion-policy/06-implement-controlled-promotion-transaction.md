# Task 05.3 - Confidence and Promotion Policy / Subtask 06 - Implement controlled promotion transaction

## Objective

Create `src/zxre/policy/service.py`. On eligible promotion: transition hypothesis to confirmed,
update/attach semantic knowledge entity/relationship, preserve prior mechanical symbol, and append
audit record. Operation must be transactional enough to avoid confirmed hypothesis without
corresponding knowledge update.
