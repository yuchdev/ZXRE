# Task 05.3 - Confidence and Promotion Policy / Subtask 04 - Implement contradiction/blocking rules

## Objective

Extend policy so unresolved contradictory evidence blocks confirmation unless explicitly
resolved/superseded. Define hard blockers such as missing source artifact, stale evidence or
unsupported external-only observation.
