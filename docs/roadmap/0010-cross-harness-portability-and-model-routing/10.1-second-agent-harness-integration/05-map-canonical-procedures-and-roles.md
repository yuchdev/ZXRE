# Task 10.1 - Second Agent Harness Integration / Subtask 05 - Map canonical procedures and roles

## Objective

Provide thin adapters/renderers for portable procedures and role descriptions supported by the
second harness. Unsupported concepts such as subagents must degrade explicitly rather than be
silently simulated.
