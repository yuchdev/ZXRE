# Task 10.1 - Second Agent Harness Integration / Subtask 02 - Implement second-harness adapter descriptor

## Objective

Create `src/zxre/harness/second.py` initially or a concrete module such as
`src/zxre/harness/codex.py` once selected. Map actual capabilities and known limitations to the
neutral harness model.
