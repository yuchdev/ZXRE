# Task 10.1 - Second Agent Harness Integration / Subtask 07 - Run bounded investigation from existing project state

## Objective

Use the Milestone 0006/0008 synthetic scenario and start from the same canonical checkpoint used by
Claude. The second harness must read/write the same evidence/hypothesis/experiment stores.
