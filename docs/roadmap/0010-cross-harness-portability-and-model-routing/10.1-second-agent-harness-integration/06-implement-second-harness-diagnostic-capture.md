# Task 10.1 - Second Agent Harness Integration / Subtask 06 - Implement second-harness diagnostic capture

## Objective

Normalize optional tool-call counts, model identity, cost/token metrics, errors and resume
identifiers into `HarnessRunDiagnostics`; diagnostics are non-canonical metadata.
