# Task 10.1 - Second Agent Harness Integration / Subtask 01 - Select and record the second reference harness

## Objective

Create `docs/harnesses/second-harness-selection.md`. Compare available MCP, agent/procedure,
structured-output and resume capabilities against `HarnessDescriptor`; select Codex by default when
viable, otherwise document the chosen alternative.
