# Task 10.6 - Cross-Harness and Companion-Tool Regression Scenarios / Subtask 08 - Generate benchmark report

## Objective

Create `src/zxre/benchmarks/report.py` producing Markdown/JSON matrices of correctness,
reproducibility, cost and convenience indicators.
