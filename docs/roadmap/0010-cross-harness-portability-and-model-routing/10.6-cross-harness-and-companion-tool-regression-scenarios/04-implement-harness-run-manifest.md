# Task 10.6 - Cross-Harness and Companion-Tool Regression Scenarios / Subtask 04 - Implement harness run manifest

## Objective

Record harness/adapter/procedure/model versions, companion descriptor, budget, start state and
resulting canonical project IDs.
