# Task 10.6 - Cross-Harness and Companion-Tool Regression Scenarios / Subtask 02 - Select benchmark scenarios

## Objective

Reuse legal synthetic entry-point, player-state and semantic-analysis scenarios; define at least one
read-heavy and one experiment-heavy goal.
