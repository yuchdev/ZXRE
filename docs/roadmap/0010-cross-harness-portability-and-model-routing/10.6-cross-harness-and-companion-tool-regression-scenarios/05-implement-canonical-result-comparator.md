# Task 10.6 - Cross-Harness and Companion-Tool Regression Scenarios / Subtask 05 - Implement canonical result comparator

## Objective

Compare confirmed hypotheses, evidence grades/sources, unresolved ledger, byte-exact reconstruction
status and experiment outcomes while ignoring prose/order differences.
