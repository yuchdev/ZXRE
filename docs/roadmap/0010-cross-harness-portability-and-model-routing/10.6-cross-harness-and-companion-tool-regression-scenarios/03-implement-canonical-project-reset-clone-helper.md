# Task 10.6 - Cross-Harness and Companion-Tool Regression Scenarios / Subtask 03 - Implement canonical project reset/clone helper

## Objective

Create `src/zxre/benchmarks/project_fixture.py` to materialize identical starting project/checkpoint
for every variant without cross-run contamination.
