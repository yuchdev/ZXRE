# Task 10.6 - Cross-Harness and Companion-Tool Regression Scenarios / Subtask 01 - Define portability benchmark model

## Objective

Create `src/zxre/benchmarks/portability.py`, package init and tests. Define scenario, harness
variant, companion variant, expected canonical assertions and metrics.
