# Task 10.6 - Cross-Harness and Companion-Tool Regression Scenarios / Subtask 06 - Collect portability metrics

## Objective

Capture success/unresolved status, tool/resource calls, experiments, elapsed time, harness-reported
model cost/tokens, companion usage and imported-vs-reproduced external observations.
