# Task 10.6 - Cross-Harness and Companion-Tool Regression Scenarios / Subtask 07 - Add with/without companion variants

## Objective

Run reference harnesses ZXRE-only and with optional companion debugger where supported. Companion
use must not change acceptance semantics.
