# Task 10.6 - Cross-Harness and Companion-Tool Regression Scenarios / Subtask 09 - Add manual/CI benchmark profiles

## Objective

Default CI runs deterministic/fake-harness components; real harness runs are explicit/manual because
they may require accounts/models. Document commands and result-artifact retention.
