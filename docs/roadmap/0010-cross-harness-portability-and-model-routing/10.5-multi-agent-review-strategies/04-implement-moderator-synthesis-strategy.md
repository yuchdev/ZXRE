# Task 10.5 - Multi-Agent Review Strategies / Subtask 04 - Implement moderator/synthesis strategy

## Objective

Create `src/zxre/collaboration/synthesis.py`. Moderator summarizes agreements/disagreements and
recommends follow-up evidence; it cannot directly confirm a hypothesis.
