# Task 10.5 - Multi-Agent Review Strategies / Subtask 01 - Define review-strategy model

## Objective

Create `src/zxre/collaboration/model.py`, package init and tests. Define `ReviewStrategy`,
`ReviewParticipant`, `IndependentAnalysis`, `Critique`, `Synthesis`, `ConsensusStatus`, and source
