# Task 10.5 - Multi-Agent Review Strategies / Subtask 07 - Add collaboration budgets

## Objective

Limit participants, critic rounds, model-cost budget and wall-clock/tool operations; integrate with
autonomy/model budgets.
