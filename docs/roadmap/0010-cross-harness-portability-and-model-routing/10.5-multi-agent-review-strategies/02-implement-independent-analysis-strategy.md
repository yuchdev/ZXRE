# Task 10.5 - Multi-Agent Review Strategies / Subtask 02 - Implement independent-analysis strategy

## Objective

Create `src/zxre/collaboration/independent.py`. Require participants to inspect the same bounded
canonical context independently and persist separate hypothesis/review outputs.
