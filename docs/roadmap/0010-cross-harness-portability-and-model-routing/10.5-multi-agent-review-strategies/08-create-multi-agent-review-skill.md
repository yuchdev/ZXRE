# Task 10.5 - Multi-Agent Review Strategies / Subtask 08 - Create multi-agent-review Skill

## Objective

Create `procedures/review-with-independent-agents.*` plus rendered harness variants using roles
available in each harness; degrade to sequential independent passes if parallel subagents are
unavailable.
