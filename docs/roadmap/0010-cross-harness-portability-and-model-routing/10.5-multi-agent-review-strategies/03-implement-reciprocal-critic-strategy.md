# Task 10.5 - Multi-Agent Review Strategies / Subtask 03 - Implement reciprocal-critic strategy

## Objective

Create `src/zxre/collaboration/reciprocal.py`. Pair analyses for explicit challenge of evidence,
alternatives and missing discriminators while preventing recursive unbounded back-and-forth.
