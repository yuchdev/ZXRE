# Task 10.5 - Multi-Agent Review Strategies / Subtask 10 - Document collaboration strategies

## Objective

Create `docs/agents/multi-agent-review.md` with when to use each strategy, independence caveats and
policy boundaries.
