# Task 10.4 - Model Capability and Cost Routing / Subtask 08 - Add fake model/provider fixtures

## Objective

Create `tests/fakes/models.py` with cheap-text, deep-reasoning and vision descriptors; verify
routing and budget behavior without external APIs.
