# Task 10.4 - Model Capability and Cost Routing / Subtask 09 - Add route-model MCP resource/tool

## Objective

Expose model registry/task routing decision and budget status as optional orchestration metadata; no
deterministic tool should require it.
