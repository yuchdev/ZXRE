# Task 10.4 - Model Capability and Cost Routing / Subtask 01 - Define model/task capability schema

## Objective

Create `src/zxre/models/model.py`, package init and tests. Define `ModelId`, `ModelDescriptor`,
`ModelCapability`, `ReasoningClass`, `Modality`, `ContextLimits`, `CostMetadata`, and
`SemanticTaskClass`.
