# Task 10.4 - Model Capability and Cost Routing / Subtask 10 - Document model routing

## Objective

Create `docs/agents/model-routing.md` covering task classes, hard capabilities, budgets, harness-
native selection and provider neutrality.
