# Task 10.4 - Model Capability and Cost Routing / Subtask 05 - Implement harness-native model mapping

## Objective

Create `src/zxre/models/harness_mapping.py` mapping route decisions to harness-specific model
selectors only where the harness supports it. Unsupported model selection becomes advisory.
