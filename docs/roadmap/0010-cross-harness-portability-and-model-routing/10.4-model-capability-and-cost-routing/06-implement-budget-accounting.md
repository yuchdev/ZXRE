# Task 10.4 - Model Capability and Cost Routing / Subtask 06 - Implement budget accounting

## Objective

Create `src/zxre/models/budget.py`. Track configured currency/token/request ceilings and combine
with Milestone 0008 research budgets without making approximate prices look exact.
