# Task 10.4 - Model Capability and Cost Routing / Subtask 07 - Implement routing telemetry

## Objective

Create `src/zxre/models/telemetry.py` for selected model, task class, estimated/actual cost when
reported, latency and fallback reason. Do not include prompt content by default.
