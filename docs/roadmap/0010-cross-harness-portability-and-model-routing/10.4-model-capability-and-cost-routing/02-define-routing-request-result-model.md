# Task 10.4 - Model Capability and Cost Routing / Subtask 02 - Define routing request/result model

## Objective

Create `src/zxre/models/routing.py`. Define `ModelRouteRequest`, required
modalities/reasoning/context, latency/cost preference, budget, allowed providers and
`ModelRouteDecision` with rationale.
