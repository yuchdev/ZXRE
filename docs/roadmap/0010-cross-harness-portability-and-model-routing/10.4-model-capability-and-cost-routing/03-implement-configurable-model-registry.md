# Task 10.4 - Model Capability and Cost Routing / Subtask 03 - Implement configurable model registry

## Objective

Create `src/zxre/models/registry.py` and `config/models.example.toml`. Load configured model
descriptors without hard-coding vendor model names into semantic services.
