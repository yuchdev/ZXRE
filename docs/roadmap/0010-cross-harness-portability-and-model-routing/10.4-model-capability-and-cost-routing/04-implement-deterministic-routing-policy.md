# Task 10.4 - Model Capability and Cost Routing / Subtask 04 - Implement deterministic routing policy

## Objective

Create `src/zxre/models/policy.py`. Filter by hard capability constraints, then rank by configured
cost/latency/quality class; return explicit no-route result when requirements cannot be met.
