# Task 10.3 - External Debugger/MCP Adapter Metadata / Subtask 05 - Validate zesarux-mcp reference descriptor

## Objective

Update/reference `zesarux_mcp.py` against the versioned schema and add full schema/capability tests.
