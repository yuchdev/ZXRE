# Task 10.3 - External Debugger/MCP Adapter Metadata / Subtask 01 - Version companion integration schema

## Objective

Refine `src/zxre/integrations/debugger/model.py` with explicit schema version, integration version,
supported platform IDs, transport kind, lifecycle ownership and documentation URI.
