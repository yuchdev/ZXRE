# Task 10.3 - External Debugger/MCP Adapter Metadata / Subtask 09 - Document companion descriptor schema

## Objective

Create `docs/mcp/companion-schema.md` including lifecycle, capability mapping and canonicalization
examples.
