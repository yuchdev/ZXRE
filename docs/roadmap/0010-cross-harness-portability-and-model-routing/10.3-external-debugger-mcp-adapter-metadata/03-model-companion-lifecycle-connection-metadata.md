# Task 10.3 - External Debugger/MCP Adapter Metadata / Subtask 03 - Model companion lifecycle/connection metadata

## Objective

Add optional launch command descriptor, endpoint/port ownership, shared-emulator safety, process
ownership and user-managed vs harness-managed lifecycle flags. Treat commands as configuration
metadata, not arbitrary execution permission.
