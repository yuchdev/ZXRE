# Task 10.3 - External Debugger/MCP Adapter Metadata / Subtask 06 - Add non-ZEsarUX reference descriptor fixture

## Objective

Create `tests/fixtures/companion_debuggers/example_debugger.py` or JSON descriptor with different
names/lifecycle to prove schema neutrality.
