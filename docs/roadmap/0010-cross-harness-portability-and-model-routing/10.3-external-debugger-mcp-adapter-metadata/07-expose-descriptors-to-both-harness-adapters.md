# Task 10.3 - External Debugger/MCP Adapter Metadata / Subtask 07 - Expose descriptors to both harness adapters

## Objective

Ensure Claude and second harness can render available companion information without changing
canonical procedure definitions.
