# Task 10.3 - External Debugger/MCP Adapter Metadata / Subtask 08 - Add schema compatibility/migration tests

## Objective

Older descriptor versions either migrate explicitly or fail with useful diagnostics; never
reinterpret fields silently.
