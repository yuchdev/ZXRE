# Task 10.3 - External Debugger/MCP Adapter Metadata / Subtask 02 - Formalize generic capability mapping

## Objective

Refine `capabilities.py` so each generic runtime/debugger capability may map to zero or more
external tool names, optional argument hints and canonicalization requirements without executable
callbacks.
