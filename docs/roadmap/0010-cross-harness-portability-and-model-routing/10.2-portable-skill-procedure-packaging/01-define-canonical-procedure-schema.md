# Task 10.2 - Portable Skill/Procedure Packaging / Subtask 01 - Define canonical procedure schema

## Objective

Create `src/zxre/procedures/model.py`, package init and tests. Define `ProcedureId`, `Procedure`,
`ProcedureStep`, `ProcedurePrerequisite`, `ProcedureOutput`, `ProcedureGuardrail`, and required ZXRE
