# Task 10.2 - Portable Skill/Procedure Packaging / Subtask 09 - Document portable procedure authoring

## Objective

Create `docs/agents/portable-procedures.md` with schema, renderer boundary, linter rules and
migration guidance.
