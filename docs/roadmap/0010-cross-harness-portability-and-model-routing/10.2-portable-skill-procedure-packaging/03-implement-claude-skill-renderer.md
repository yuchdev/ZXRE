# Task 10.2 - Portable Skill/Procedure Packaging / Subtask 03 - Implement Claude Skill renderer

## Objective

Create `src/zxre/procedures/render_claude.py`. Generate or validate `skills/*/SKILL.md` from
canonical procedures while allowing clearly separated Claude presentation text.
