# Task 10.2 - Portable Skill/Procedure Packaging / Subtask 05 - Implement procedure portability linter

## Objective

Create `src/zxre/procedures/lint.py`. Reject raw ZRCP commands, `zesarux-mcp` tool names, Claude-
only assumptions and unbounded output requests in canonical procedure definitions.
