# Task 10.2 - Portable Skill/Procedure Packaging / Subtask 04 - Implement second-harness procedure renderer

## Objective

Create `src/zxre/procedures/render_second.py` (renamed to selected harness module later). Produce
the native procedure/instruction representation or a documented prompt artifact where no first-class
