# Task 10.0 - Harness-Neutral Workflow Contract / Subtask 07 - Add Claude adapter over existing Milestone 0006 assets

## Objective

Create `src/zxre/harness/claude.py` and tests mapping canonical roles/procedures/configuration to
existing `CLAUDE.md`, `.claude/agents/` and Skills without moving their semantics into adapter code.
