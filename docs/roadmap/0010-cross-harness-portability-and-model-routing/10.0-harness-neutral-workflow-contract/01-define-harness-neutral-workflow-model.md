# Task 10.0 - Harness-Neutral Workflow Contract / Subtask 01 - Define harness-neutral workflow model

## Objective

Create `src/zxre/harness/model.py`, package init and tests. Define `HarnessId`, `HarnessDescriptor`,
`WorkflowId`, `WorkflowGoal`, `WorkflowStep`, `WorkflowDecision`, `WorkflowResult`,
`WorkflowStatus`, and canonical project-state references.
