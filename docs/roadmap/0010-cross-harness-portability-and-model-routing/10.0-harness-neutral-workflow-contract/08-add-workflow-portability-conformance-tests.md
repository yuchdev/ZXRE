# Task 10.0 - Harness-Neutral Workflow Contract / Subtask 08 - Add workflow portability conformance tests

## Objective

Create `tests/harness/test_workflow_contract.py`. Verify canonical workflow state round-trips and
can be rendered by a fake harness adapter with no Claude-specific fields.
