# Task 10.0 - Harness-Neutral Workflow Contract / Subtask 03 - Define portable decision/result schemas

## Objective

Create `src/zxre/harness/protocol.py` with structured decisions such as inspect resource, invoke
canonical tool, propose hypothesis, request experiment, request critic, stop resolved/unresolved.
Reuse Milestone 0008 autonomy decisions where possible instead of duplicating them.
