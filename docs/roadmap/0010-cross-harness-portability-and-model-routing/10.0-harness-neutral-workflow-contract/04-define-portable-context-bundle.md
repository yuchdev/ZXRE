# Task 10.0 - Harness-Neutral Workflow Contract / Subtask 04 - Define portable context bundle

## Objective

Create `src/zxre/harness/context.py`. Build a bounded context descriptor referencing project
summary, selected entities/hypotheses/frontier items, procedure IDs and budgets; large artifacts
remain resource references.
