# Task 10.0 - Harness-Neutral Workflow Contract / Subtask 02 - Define harness capability model

## Objective

Create `src/zxre/harness/capabilities.py`. Describe MCP support, subagents, reusable
procedures/Skills, structured outputs, model selection, image input, parallel agents and
resumability as capabilities rather than assumptions.
