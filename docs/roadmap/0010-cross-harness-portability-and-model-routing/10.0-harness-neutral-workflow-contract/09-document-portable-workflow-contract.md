# Task 10.0 - Harness-Neutral Workflow Contract / Subtask 09 - Document portable workflow contract

## Objective

Create `docs/harnesses/workflow-contract.md` with portable vs harness-specific responsibilities,
checkpoint/handoff behavior and non-goal of universal orchestration.
