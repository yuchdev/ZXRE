# Task 06.7 - Optional Companion MCP Configuration / Subtask 07 - Add fake alternative companion example

## Objective

Show a differently named debugger MCP mapped through generic capability metadata.
