# Task 06.7 - Optional Companion MCP Configuration / Subtask 05 - Define agent usage rules for companion MCP

## Objective

Document exploratory uses and requirement to reproduce/import observations before final
confirmation.
