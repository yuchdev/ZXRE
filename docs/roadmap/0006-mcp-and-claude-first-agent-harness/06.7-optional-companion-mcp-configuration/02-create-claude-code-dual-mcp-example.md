# Task 06.7 - Optional Companion MCP Configuration / Subtask 02 - Create Claude Code dual-MCP example

## Objective

Create `docs/mcp/companions/claude-zxre-zesarux.md` with ZXRE MCP + `zesarux-mcp` configuration
concepts, separate names and safe path/port guidance.
