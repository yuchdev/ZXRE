# Task 06.7 - Optional Companion MCP Configuration / Subtask 06 - Add configuration validation script where practical

## Objective

Validate example JSON/TOML syntax/placeholders without launching MCP servers.
