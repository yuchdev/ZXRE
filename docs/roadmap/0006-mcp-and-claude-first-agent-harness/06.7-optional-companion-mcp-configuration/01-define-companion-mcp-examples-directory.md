# Task 06.7 - Optional Companion MCP Configuration / Subtask 01 - Define companion-MCP examples directory

## Objective

Create `docs/mcp/companions/README.md` describing side-by-side architecture, lifecycle and harness-
