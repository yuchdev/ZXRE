# Task 06.7 - Optional Companion MCP Configuration / Subtask 04 - Document shared-emulator lifecycle rules

## Objective

Cover port/process ownership, auto-launch conflicts and safe shared-session patterns; prefer
explicit external emulator lifecycle where safest.
