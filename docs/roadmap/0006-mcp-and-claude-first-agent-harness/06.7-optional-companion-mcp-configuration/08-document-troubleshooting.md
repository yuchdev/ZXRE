# Task 06.7 - Optional Companion MCP Configuration / Subtask 08 - Document troubleshooting

## Objective

Create `docs/mcp/companions/troubleshooting.md` for port conflicts, stdout corruption, ownership and
ZXRE-only fallback.
