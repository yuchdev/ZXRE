# Task 06.7 - Optional Companion MCP Configuration / Subtask 03 - Create second-harness conceptual example

## Objective

Document a second MCP-capable harness setup only using verified syntax; otherwise keep it conceptual
rather than inventing config keys.
