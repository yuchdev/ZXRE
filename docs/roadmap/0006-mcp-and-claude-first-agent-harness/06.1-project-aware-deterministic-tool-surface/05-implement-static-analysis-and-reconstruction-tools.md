# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 05 - Implement static-analysis and reconstruction tools

## Objective

Create `src/zxre/mcp/tools/static.py` for bounded disassembly, control-map queries/updates,
references, routine candidates, reconstruction and byte-exact verification.
