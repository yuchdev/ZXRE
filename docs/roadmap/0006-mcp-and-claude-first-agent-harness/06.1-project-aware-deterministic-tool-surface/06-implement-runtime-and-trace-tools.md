# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 06 - Implement runtime and trace tools

## Objective

Create `src/zxre/mcp/tools/runtime.py` and `trace.py` for capabilities/session info, snapshot
restore, memory/register access, step/run, breakpoints, input, capture and trace queries.
