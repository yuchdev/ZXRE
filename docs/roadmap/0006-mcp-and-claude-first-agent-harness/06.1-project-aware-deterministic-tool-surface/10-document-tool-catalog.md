# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 10 - Document tool catalog

## Objective

Create `docs/mcp/tools.md` with categories, inputs/outputs, read/write classification and examples.
