# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 07 - Implement evidence, hypothesis, experiment and frontier tools

## Objective

Create `src/zxre/mcp/tools/knowledge.py` and `experiment.py`; expose
evidence/hypothesis/entity/experiment/frontier operations. Promotion must always delegate to policy
service.
