# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 08 - Add tool authorization/safety boundaries

## Objective

Create `src/zxre/mcp/tools/policy.py` if needed. Enforce allowed project roots, mutation policy,
bounded host-file operations and no arbitrary external command execution.
