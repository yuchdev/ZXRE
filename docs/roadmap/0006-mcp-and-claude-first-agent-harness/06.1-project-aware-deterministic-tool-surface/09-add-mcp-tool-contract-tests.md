# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 09 - Add MCP tool contract tests

## Objective

Create `tests/mcp/test_tools_*.py` using temporary projects and fake runtime backend; verify
schemas, limits, errors and service delegation.
