# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 01 - Define MCP tool naming and schema conventions

## Objective

Create `src/zxre/mcp/tools/common.py` and tests. Establish stable categories/naming, common
project/address/range/pagination schemas and read-only vs mutating metadata.
