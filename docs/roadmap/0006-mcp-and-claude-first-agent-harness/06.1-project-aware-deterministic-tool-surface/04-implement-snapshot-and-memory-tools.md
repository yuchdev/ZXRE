# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 04 - Implement snapshot and memory tools

## Objective

Create `src/zxre/mcp/tools/snapshot.py` and `memory.py` for snapshot create/list/describe and memory
read/export/diff, using artifact refs for large data.
