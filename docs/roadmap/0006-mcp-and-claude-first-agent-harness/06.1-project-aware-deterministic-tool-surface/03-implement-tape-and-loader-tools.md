# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 03 - Implement tape and loader tools

## Objective

Create `src/zxre/mcp/tools/tape.py` for tape inventory, block details/extraction, decoded BASIC
loaders and explicit candidate addresses.
