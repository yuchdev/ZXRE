# Task 06.1 - Project-Aware Deterministic Tool Surface / Subtask 02 - Implement project and artifact tools

## Objective

Create `src/zxre/mcp/tools/project.py` for project info, inputs, artifact list/verify and platform
info with bounded/paginated outputs.
