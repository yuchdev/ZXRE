# Task 06.2 - MCP Resource Surface / Subtask 08 - Add stale-source/version indicators

## Objective

Mark resources stale when derived analyses no longer match current control-map/disassembly/static-
flow versions.
