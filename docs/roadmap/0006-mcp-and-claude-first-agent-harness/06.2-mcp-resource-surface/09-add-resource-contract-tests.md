# Task 06.2 - MCP Resource Surface / Subtask 09 - Add resource contract tests

## Objective

Test URI parsing, side-effect-free reads, missing resources, limits and stale indicators.
