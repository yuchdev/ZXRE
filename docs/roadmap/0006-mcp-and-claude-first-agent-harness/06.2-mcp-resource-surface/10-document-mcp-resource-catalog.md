# Task 06.2 - MCP Resource Surface / Subtask 10 - Document MCP resource catalog

## Objective

Create `docs/mcp/resources.md` describing URIs, intended context use and size limits.
