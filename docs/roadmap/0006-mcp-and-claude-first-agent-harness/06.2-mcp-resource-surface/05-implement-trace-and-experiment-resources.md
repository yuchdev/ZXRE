# Task 06.2 - MCP Resource Surface / Subtask 05 - Implement trace and experiment resources

## Objective

Create `src/zxre/mcp/resources/runtime.py` for trace/capture/experiment summaries and source
snapshot/backend references.
