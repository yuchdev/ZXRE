# Task 06.2 - MCP Resource Surface / Subtask 06 - Implement runtime capability resource

## Objective

Expose active backend and generic capabilities/extensions without emulator-specific core semantics.
