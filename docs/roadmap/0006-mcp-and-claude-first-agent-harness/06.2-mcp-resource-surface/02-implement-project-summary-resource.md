# Task 06.2 - MCP Resource Surface / Subtask 02 - Implement project summary resource

## Objective

Create `src/zxre/mcp/resources/project.py` returning identity, platform, important counts/status,
verification state and open/confirmed hypothesis summaries.
