# Task 06.2 - MCP Resource Surface / Subtask 01 - Define resource URI scheme

## Objective

Create `src/zxre/mcp/resources/uris.py` and tests with URIs for project summary, memory map,
routine/entity/hypothesis/trace/experiment/frontier/runtime-capabilities.
