# Task 06.2 - MCP Resource Surface / Subtask 04 - Implement knowledge/evidence/hypothesis resources

## Objective

Create `src/zxre/mcp/resources/knowledge.py` with entity relationships, hypothesis status, evidence
summaries and promotion blockers.
