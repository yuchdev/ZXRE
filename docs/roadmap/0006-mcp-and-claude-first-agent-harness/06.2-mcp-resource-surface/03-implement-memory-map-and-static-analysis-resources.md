# Task 06.2 - MCP Resource Surface / Subtask 03 - Implement memory-map and static-analysis resources

## Objective

Create `src/zxre/mcp/resources/static.py` for compact control coverage, routine details,
callers/callees, references and reconstruction status.
