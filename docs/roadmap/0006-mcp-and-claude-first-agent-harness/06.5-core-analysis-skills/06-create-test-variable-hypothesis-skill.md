# Task 06.5 - Core Analysis Skills / Subtask 06 - Create test-variable-hypothesis Skill

## Objective

Create `skills/test-variable-hypothesis/SKILL.md` for memory refs/diffs, deterministic experiment
execution, evidence attachment and promotion evaluation.
