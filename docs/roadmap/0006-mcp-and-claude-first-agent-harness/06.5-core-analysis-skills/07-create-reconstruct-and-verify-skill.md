# Task 06.5 - Core Analysis Skills / Subtask 07 - Create reconstruct-and-verify Skill

## Objective

Create `skills/reconstruct-and-verify/SKILL.md` for mechanical source generation, byte-exact
verification and mismatch handling.
