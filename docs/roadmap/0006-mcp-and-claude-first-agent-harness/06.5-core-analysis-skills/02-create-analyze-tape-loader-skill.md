# Task 06.5 - Core Analysis Skills / Subtask 02 - Create analyze-tape-loader Skill

## Objective

Create `skills/analyze-tape-loader/SKILL.md` for inventory, BASIC loader decoding, load/USR
candidate handling and unresolved loader questions.
