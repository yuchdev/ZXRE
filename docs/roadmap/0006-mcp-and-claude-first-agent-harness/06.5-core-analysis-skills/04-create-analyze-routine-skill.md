# Task 06.5 - Core Analysis Skills / Subtask 04 - Create analyze-routine Skill

## Objective

Create `skills/analyze-routine/SKILL.md` for static/runtime context, semantic hypotheses, unknowns
