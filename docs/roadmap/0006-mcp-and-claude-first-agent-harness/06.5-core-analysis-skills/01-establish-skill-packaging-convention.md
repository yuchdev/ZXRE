# Task 06.5 - Core Analysis Skills / Subtask 01 - Establish Skill packaging convention

## Objective

Create `skills/README.md` and canonical Skill directory format with `SKILL.md` plus optional
references/examples.
