# Task 06.5 - Core Analysis Skills / Subtask 10 - Document Skill authoring guidelines

## Objective

Create `docs/agents/skills.md` on progressive disclosure, bounded workflows, verification, evidence
citations and portability.
