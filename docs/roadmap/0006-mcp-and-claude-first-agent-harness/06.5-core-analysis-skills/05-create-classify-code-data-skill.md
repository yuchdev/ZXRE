# Task 06.5 - Core Analysis Skills / Subtask 05 - Create classify-code-data Skill

## Objective

Create `skills/classify-code-data/SKILL.md` combining control map, decode diagnostics and runtime
coverage while preserving unexecuted ≠ data.
