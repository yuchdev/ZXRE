# Task 06.5 - Core Analysis Skills / Subtask 08 - Create hypothesis-review Skill

## Objective

Create `skills/review-hypothesis/SKILL.md` gathering support/contradiction, competing hypotheses,
evidence grade and blockers.
