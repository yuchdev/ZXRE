# Task 06.5 - Core Analysis Skills / Subtask 03 - Create locate-real-entry-point Skill

## Objective

Create `skills/locate-real-entry-point/SKILL.md` using candidate entry, capabilities,
breakpoints/traces, relocation clues, post-bootstrap snapshot and hypotheses/evidence.
