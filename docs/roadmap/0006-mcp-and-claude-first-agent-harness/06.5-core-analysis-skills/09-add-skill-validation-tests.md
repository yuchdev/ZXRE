# Task 06.5 - Core Analysis Skills / Subtask 09 - Add Skill validation tests

## Objective

Validate generic ZXRE terminology, explicit verification/exit conditions and absence of raw
ZRCP/zesarux-specific tool names except optional examples.
