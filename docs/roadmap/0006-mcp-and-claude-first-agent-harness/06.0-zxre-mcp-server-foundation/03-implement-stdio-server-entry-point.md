# Task 06.0 - ZXRE MCP Server Foundation / Subtask 03 - Implement stdio server entry point

## Objective

Create `src/zxre/mcp/__main__.py` and console script `zxre-mcp`. Keep stdout exclusively for MCP
protocol; logs go to stderr. Add smoke tests.
