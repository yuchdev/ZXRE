# Task 06.0 - ZXRE MCP Server Foundation / Subtask 02 - Define MCP server configuration

## Objective

Implement `McpServerConfig` for stdio transport, allowed project roots, log level, operation timeout
and optional runtime-backend selection. No Claude- or emulator-specific settings here.
