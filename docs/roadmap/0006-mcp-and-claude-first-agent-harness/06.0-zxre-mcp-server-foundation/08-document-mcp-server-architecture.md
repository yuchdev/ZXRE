# Task 06.0 - ZXRE MCP Server Foundation / Subtask 08 - Document MCP server architecture

## Objective

Create `docs/architecture/mcp-server.md` covering transport, project context, errors, logging,
harness neutrality and business-logic separation.
