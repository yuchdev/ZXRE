# Task 06.0 - ZXRE MCP Server Foundation / Subtask 06 - Define common result/serialization helpers

## Objective

Create `src/zxre/mcp/serialization.py` for IDs, addresses/ranges, enums, artifact refs, diagnostics,
pagination and bounded byte rendering.
