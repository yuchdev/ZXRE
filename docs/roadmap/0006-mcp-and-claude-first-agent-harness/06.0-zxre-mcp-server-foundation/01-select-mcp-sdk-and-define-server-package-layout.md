# Task 06.0 - ZXRE MCP Server Foundation / Subtask 01 - Select MCP SDK and define server package layout

## Objective

Create `src/zxre/mcp/__init__.py`, `server.py`, `config.py`, and tests. Select a maintained Python
MCP SDK compatible with the project baseline and pin/document an appropriate version range.
