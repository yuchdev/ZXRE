# Task 06.0 - ZXRE MCP Server Foundation / Subtask 05 - Define MCP error mapping

## Objective

Create `src/zxre/mcp/errors.py` mapping project/runtime/artifact/capability/policy errors to stable
machine-readable MCP errors without leaking stack traces/secrets.
