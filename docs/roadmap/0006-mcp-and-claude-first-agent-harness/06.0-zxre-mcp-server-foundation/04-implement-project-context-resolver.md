# Task 06.0 - ZXRE MCP Server Foundation / Subtask 04 - Implement project-context resolver

## Objective

Create `src/zxre/mcp/context.py` to safely resolve/open project paths, enforce configured roots and
reject traversal/out-of-scope access.
