# Task 06.0 - ZXRE MCP Server Foundation / Subtask 07 - Add server lifecycle and graceful shutdown tests

## Objective

Create `tests/mcp/test_server_lifecycle.py` covering startup, registration, cancellation, stderr-
only logging and cleanup of ZXRE-owned runtime sessions/processes.
