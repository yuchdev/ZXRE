# Task 06.8 - Guided End-to-End Investigation / Subtask 02 - Define investigation goal and acceptance contract

## Objective

Create `tests/scenarios/m0006-entry-point/README.md` with allowed tools, goal, expected canonical
outputs and success/unresolved criteria.
