# Task 06.8 - Guided End-to-End Investigation / Subtask 04 - Create guided investigation procedure

## Objective

Create `docs/agents/scenarios/identify-entry-point.md` instructing Investigator to use resources,
Skills, runtime evidence, hypotheses and Critic review.
