# Task 06.8 - Guided End-to-End Investigation / Subtask 08 - Add optional companion-MCP variant

## Objective

Document variant using `zesarux-mcp` for exploration; core scenario must also work without it and
canonical verifier remains unchanged.
