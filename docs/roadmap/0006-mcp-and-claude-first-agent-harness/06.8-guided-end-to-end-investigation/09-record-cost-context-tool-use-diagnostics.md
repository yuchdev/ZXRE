# Task 06.8 - Guided End-to-End Investigation / Subtask 09 - Record cost/context/tool-use diagnostics

## Objective

Optionally capture MCP calls/resource reads/artifact sizes/agent turns when harness exposes them;
diagnostic only.
