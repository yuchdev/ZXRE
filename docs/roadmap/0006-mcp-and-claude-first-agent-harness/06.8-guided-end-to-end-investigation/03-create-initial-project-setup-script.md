# Task 06.8 - Guided End-to-End Investigation / Subtask 03 - Create initial project setup script

## Objective

Create deterministic helper that initializes/imports/preprocesses through Milestones 0002–0004 but
leaves semantic entry question unresolved.
