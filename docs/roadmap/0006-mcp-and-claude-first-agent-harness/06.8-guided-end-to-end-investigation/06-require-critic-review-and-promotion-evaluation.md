# Task 06.8 - Guided End-to-End Investigation / Subtask 06 - Require critic review and promotion evaluation

## Objective

Require Critic/Verifier pass and policy evaluation; result stays unconfirmed if policy requirements
are unmet.
