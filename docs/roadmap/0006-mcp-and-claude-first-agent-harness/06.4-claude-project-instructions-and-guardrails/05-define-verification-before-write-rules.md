# Task 06.4 - Claude Project Instructions and Guardrails / Subtask 05 - Define verification-before-write rules

## Objective

Require deterministic verification/evidence before control-map changes, confirmations or semantic
naming; byte-exact mechanical reconstruction stays ground truth.
