# Task 06.4 - Claude Project Instructions and Guardrails / Subtask 03 - Define runtime/debugger guardrails

## Objective

Require capability checks, canonical runtime tools for evidence and treat external emulator MCPs as
