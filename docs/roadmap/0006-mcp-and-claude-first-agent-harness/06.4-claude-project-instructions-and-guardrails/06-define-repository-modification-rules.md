# Task 06.4 - Claude Project Instructions and Guardrails / Subtask 06 - Define repository modification rules

## Objective

When coding, follow task/subtask specs, update tests/docs/status and avoid implementing later
