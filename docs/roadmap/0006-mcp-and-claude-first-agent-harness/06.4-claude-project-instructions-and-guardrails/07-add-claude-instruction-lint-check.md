# Task 06.4 - Claude Project Instructions and Guardrails / Subtask 07 - Add Claude instruction lint/check

## Objective

Add lightweight test/script asserting required guardrail sections remain present without snapshot-
testing prose.
