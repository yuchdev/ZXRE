# Task 06.4 - Claude Project Instructions and Guardrails / Subtask 08 - Document Claude adapter status

## Objective

Create `docs/harnesses/claude-code.md` with ZXRE MCP setup, optional companion MCP and
replaceability.
