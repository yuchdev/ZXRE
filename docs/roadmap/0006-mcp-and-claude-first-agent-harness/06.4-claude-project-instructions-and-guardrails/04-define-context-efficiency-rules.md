# Task 06.4 - Claude Project Instructions and Guardrails / Subtask 04 - Define context-efficiency rules

## Objective

Prefer compact resources before large tool calls; bound address ranges and use artifact references.
