# Task 06.6 - Role-Based Agents / Subtask 05 - Create Dynamic Analyst role

## Objective

Create `agents/dynamic-analyst.md` specializing in runtime observation, breakpoints/watchpoints,
traces and reproducible experiments using generic capabilities.
