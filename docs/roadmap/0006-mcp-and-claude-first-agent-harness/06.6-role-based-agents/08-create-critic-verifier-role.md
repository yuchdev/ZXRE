# Task 06.6 - Role-Based Agents / Subtask 08 - Create Critic/Verifier role

## Objective

Create `agents/critic-verifier.md` to challenge claims, detect circular reasoning, inspect
provenance and request counter-tests.
