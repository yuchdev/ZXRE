# Task 06.6 - Role-Based Agents / Subtask 01 - Define canonical agent-role schema

## Objective

Create `agents/README.md` and canonical role metadata (`agents/roles.yaml` or equivalent) with
mission, responsibilities, prohibitions, preferred Skills/resources and expected state updates.
