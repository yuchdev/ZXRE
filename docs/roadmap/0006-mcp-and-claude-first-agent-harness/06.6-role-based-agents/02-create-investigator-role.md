# Task 06.6 - Role-Based Agents / Subtask 02 - Create Investigator role

## Objective

Create `agents/investigator.md` to maintain bounded goal, consult frontier, delegate specialists and
enforce canonical evidence/stop conditions.
