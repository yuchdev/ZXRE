# Task 06.6 - Role-Based Agents / Subtask 07 - Create Reconstruction Agent role

## Objective

Create `agents/reconstruction.md` for faithful source, byte-exact verification and use of already-
confirmed semantic names only.
