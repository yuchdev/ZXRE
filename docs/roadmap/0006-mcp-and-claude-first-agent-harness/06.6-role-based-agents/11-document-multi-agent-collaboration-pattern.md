# Task 06.6 - Role-Based Agents / Subtask 11 - Document multi-agent collaboration pattern

## Objective

Create `docs/agents/roles.md` with durable-state collaboration examples.
