# Task 06.6 - Role-Based Agents / Subtask 03 - Create Loader Analyst role

## Objective

Create `agents/loader-analyst.md` specializing in loaders, relocation/decompression/bootstrap and
entry discovery.
