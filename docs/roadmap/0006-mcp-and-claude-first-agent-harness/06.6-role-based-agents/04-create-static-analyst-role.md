# Task 06.6 - Role-Based Agents / Subtask 04 - Create Static Analyst role

## Objective

Create `agents/static-analyst.md` specializing in disassembly, flow, code/data and structures while
labeling interpretations as hypotheses.
