# Task 06.6 - Role-Based Agents / Subtask 06 - Create Asset Analyst role

## Objective

Create `agents/asset-analyst.md` for screen/graphics/data-region preparation and candidate asset
typing without future vision automation assumptions.
