# Task 06.6 - Role-Based Agents / Subtask 09 - Create Claude Code agent adapters

## Objective

Map canonical roles into current Claude Code subagent configuration under `.claude/agents/` or
supported convention; keep adapters thin.
