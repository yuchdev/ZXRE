# Task 06.3 - External-Tool Capability and Provenance Rules / Subtask 05 - Define Skills-facing preference rules

## Objective

Create `src/zxre/mcp/external_policy.py`: prefer ZXRE canonical tools; use companion tools only for
unsupported/exploratory work; import/reproduce before confirmation.
