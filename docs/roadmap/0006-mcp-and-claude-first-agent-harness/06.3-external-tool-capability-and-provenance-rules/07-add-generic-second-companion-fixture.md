# Task 06.3 - External-Tool Capability and Provenance Rules / Subtask 07 - Add generic second-companion fixture

## Objective

Create a fake companion descriptor with different tool names to prove the model is not tied to
ZEsarUX naming.
