# Task 06.3 - External-Tool Capability and Provenance Rules / Subtask 06 - Add zesarux-mcp mapping verification tests

## Objective

Validate the reference descriptor mappings without requiring Node or `zesarux-mcp` installation.
