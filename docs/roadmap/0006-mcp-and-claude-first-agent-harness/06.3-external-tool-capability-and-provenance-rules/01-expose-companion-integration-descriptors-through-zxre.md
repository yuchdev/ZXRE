# Task 06.3 - External-Tool Capability and Provenance Rules / Subtask 01 - Expose companion integration descriptors through ZXRE

## Objective

Create `src/zxre/mcp/external_tools.py` exposing registered companion IDs, generic capabilities,
platform compatibility and docs references without invoking them.
