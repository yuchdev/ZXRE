# Task 06.3 - External-Tool Capability and Provenance Rules / Subtask 04 - Implement reproduce-through-ZXRE workflow helper

## Objective

Create helper that translates supported exploratory observation requests into canonical
RuntimeService operations; it must not call another MCP server.
