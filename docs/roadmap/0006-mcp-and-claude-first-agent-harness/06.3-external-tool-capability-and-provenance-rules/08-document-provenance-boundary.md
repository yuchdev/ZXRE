# Task 06.3 - External-Tool Capability and Provenance Rules / Subtask 08 - Document provenance boundary

## Objective

Create `docs/mcp/external-tools.md` with exploratory-vs-canonical examples.
