# Task 06.3 - External-Tool Capability and Provenance Rules / Subtask 02 - Define canonicalization status model

## Objective

Create `src/zxre/integrations/debugger/canonicalization.py` with states such as `EXPLORATORY`,
`IMPORTED_EXTERNAL`, `REPRODUCED_BY_ZXRE`, `CANONICAL`.
