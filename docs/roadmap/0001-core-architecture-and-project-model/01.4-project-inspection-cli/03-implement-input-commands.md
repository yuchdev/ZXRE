# Task 01.4 - Project Inspection CLI / Subtask 03 - Implement input commands
...
`zxre input add PROJECT FILE [--description ...]`
`zxre input list PROJECT [--json]`

`input add` must use project/artifact services, compute/store content identity, preserve original
filename metadata, and never parse TAP/TZX yet.

Tests:
add/reopen/list, duplicate-content behavior, missing file, invalid project.
