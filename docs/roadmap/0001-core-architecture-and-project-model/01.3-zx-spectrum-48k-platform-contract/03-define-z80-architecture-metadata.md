# Task 01.3 - ZX Spectrum 48K Platform Contract / Subtask 03 - Define Z80 architecture metadata

## Objective

Create `src/zxre/platforms/z80.py`.

## Implementation specification

Provide only static architecture metadata needed by Milestone 0001:
- architecture ID;
- address width;
- conventional register names as descriptive metadata if needed;
- endianness.

Do not implement instruction decoding/disassembly; that belongs to Milestone 0003.
Do not implement execution state; that belongs to Milestone 0004.
